 ...
 * 접근 검증용 존재 조회는 query 쪽 [com.org.oneulsogae.core.chat.query.dao.ExistsChatRoomMemberDao]가,
 * 프로필 조인이 필요한 참가자 조회는 [com.org.oneulsogae.core.chat.query.dao.GetChatParticipantDao]가 담당한다.
 */
