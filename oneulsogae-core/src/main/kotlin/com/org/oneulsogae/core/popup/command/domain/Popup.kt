package com.org.oneulsogae.core.popup.command.domain
 ...
 * 조회는 도메인 모델 대신 query 측 read model([com.org.oneulsogae.core.popup.query.dto.PopupView])을 쓴다.
 * 영속성은 [com.org.oneulsogae.infra.popup.command.entity.PopupEntity]가 담당한다.
 */
data class Popup(
	val id: Long = 0,
