...
/**
 * 팀(헤더+구성원) 저장 아웃포트.
 * 구현은 infra의 어댑터가 [com.org.oneulsogae.infra.teammatch.command.entity.TeamEntity]/[com.org.oneulsogae.infra.teammatch.command.entity.TeamMemberEntity]로 영속화한다.
 */
