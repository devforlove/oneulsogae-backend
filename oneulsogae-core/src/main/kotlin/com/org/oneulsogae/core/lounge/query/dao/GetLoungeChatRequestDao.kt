...
interface GetLoungeChatRequestDao {
	 ...
	 * PENDING 신청은 [pendingAfter] 이후에 만들어진 것만 포함한다. (만료된 신청 제외 — ACCEPTED는 항상 포함)
	 */
	fun findReceivedPage(receiverUserId: Long, beforeId: Long?, limit: Int, pendingAfter: LocalDateTime): List<LoungeChatRequestView>
	 ...
	 * PENDING 신청은 [pendingAfter] 이후에 만들어진 것만 포함한다. (만료된 신청 제외 — ACCEPTED는 항상 포함)
	 */
	fun findSentPage(requesterUserId: Long, beforeId: Long?, limit: Int, pendingAfter: LocalDateTime): List<LoungeChatRequestView>
}
