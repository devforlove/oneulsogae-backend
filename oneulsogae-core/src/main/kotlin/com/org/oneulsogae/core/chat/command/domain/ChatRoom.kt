 ...
 * 영속성은 [com.org.oneulsogae.infra.chat.command.entity.ChatRoomEntity]가 담당한다.
 */
data class ChatRoom(
	val id: Long = 0,
	 ...
	 * (참가 여부는 방이 아니라 [com.org.oneulsogae.core.chat.query.dto.ChatParticipants.validateParticipant]가 검증한다)
	 */
