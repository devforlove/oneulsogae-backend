...
**Files:**
- Modify: `meeple-common/src/main/kotlin/com/org/meeple/common/popup/PopupType.kt`
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/popup/command/domain/Popup.kt`
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/popup/command/application/port/in/CreateRefundPopupUseCase.kt`
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/popup/command/application/CreateRefundPopupService.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/domain/popup/PopupTest.kt` (신규)
...
`meeple-api/src/test/kotlin/com/org/meeple/domain/popup/PopupTest.kt` 신규:
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.domain.popup.PopupTest"`
Expected: PASS

- [ ] **Step 7: 커밋**

```bash
git add meeple-common meeple-core meeple-api/src/test/kotlin/com/org/meeple/domain/popup/PopupTest.kt
...
- Test: `meeple-api/src/test/kotlin/com/org/meeple/domain/match/MatchedTeamTest.kt` (갱신)
- Test: `meeple-api/src/test/kotlin/com/org/meeple/domain/match/MatchedTeamsTest.kt` (갱신)
- Test: `meeple-api/src/test/kotlin/com/org/meeple/domain/match/TeamMatchTest.kt` (갱신 + failureRefunds 추가)

**Interfaces:**
- Consumes: `MatchRefund(userId: Long, amount: Int)` (기존, `com.org.meeple.core.match.command.domain`).
...
`TeamMatch.kt` 상단 import에 `import com.org.meeple.core.match.command.domain.MatchedTeam`는 같은 패키지라 불필요. `MatchRefund`도 같은 패키지라 불필요.
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.domain.match.TeamMatchTest" --tests "com.org.meeple.domain.match.MatchedTeamTest" --tests "com.org.meeple.domain.match.MatchedTeamsTest"`
Expected: PASS

- [ ] **Step 8: 커밋**

```bash
git add meeple-core meeple-api/src/test/kotlin/com/org/meeple/domain/match
...
**Files:**
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/match/command/entity/MatchedTeamEntity.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/match/command/mapper/MatchedTeamMapper.kt`
...
Run: `./gradlew :meeple-infra:compileKotlin && ./gradlew :meeple-api:test --tests "com.org.meeple.api.match.SendTeamInterestE2ETest"`
Expected: PASS (신청 시 applicant_user_id가 채워져도 기존 시나리오 그대로 통과)

- [ ] **Step 5: 커밋**

```bash
git add meeple-infra docs/migration/matched_teams_applicant_user_id.sql
...
**Files:**
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/match/command/application/port/in/ExpireMatchUseCase.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/match/command/application/ExpireMatchService.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/api/scheduler/ExpireMatchServiceIntegrationTest.kt` (신규)
...
`meeple-api/src/test/kotlin/com/org/meeple/api/scheduler/ExpireMatchServiceIntegrationTest.kt` 신규:
...
`meeple-core/src/main/kotlin/com/org/meeple/core/match/command/application/port/in/ExpireMatchUseCase.kt`:
...
`meeple-core/src/main/kotlin/com/org/meeple/core/match/command/application/ExpireMatchService.kt`:
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.api.scheduler.ExpireMatchServiceIntegrationTest"`
Expected: PASS

- [ ] **Step 6: 커밋**

```bash
git add meeple-core meeple-api/src/test/kotlin/com/org/meeple/api/scheduler/ExpireMatchServiceIntegrationTest.kt
...
**Files:**
- Create: `meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/command/domain/ExpireMatchBatchResult.kt`
- Create: `meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/command/application/port/in/RunExpireMatchBatchUseCase.kt`
- Create: `meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/command/application/port/out/GetExpiredMatchPort.kt`
- Create: `meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/command/application/port/out/ExpireMatchPort.kt`
- Create: `meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/command/application/ExpireMatchBatchService.kt`
- Create: `meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/command/adapter/ExpireMatchBatchJob.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/scheduler/match/ExpireMatchBatchServiceTest.kt` (신규, 페이크 포트 유닛 테스트)

**Interfaces:**
- Consumes: scheduler `TimeGenerator.now()` (`com.org.meeple.scheduler.match.command.application.port.out.TimeGenerator`).
...
`meeple-api/src/test/kotlin/com/org/meeple/scheduler/match/ExpireMatchBatchServiceTest.kt`:

```kotlin
package com.org.meeple.scheduler.match

import com.org.meeple.scheduler.match.command.application.ExpireMatchBatchService
...
Run: `./gradlew :meeple-scheduler:compileKotlin && ./gradlew :meeple-api:test --tests "com.org.meeple.scheduler.match.ExpireMatchBatchServiceTest"`
Expected: PASS

> 주의: 이 시점엔 `GetExpiredMatchPort`·`ExpireMatchPort` 구현체가 없어 `:meeple-api` 전체 컨텍스트 기동은 실패할 수 있다. 위 유닛 테스트는 페이크라 통과한다. 전체 컨텍스트는 Task 6 이후 검증한다.

- [ ] **Step 8: 커밋**

```bash
git add meeple-scheduler meeple-api/src/test/kotlin/com/org/meeple/scheduler/match/ExpireMatchBatchServiceTest.kt
...
**Files:**
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/match/query/GetExpiredMatchDaoImpl.kt`
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/match/command/adapter/ExpireMatchBridgeAdapter.kt`
...
- Produces: 두 포트의 Spring 빈 구현 → `:meeple-api` 전체 컨텍스트가 기동 가능해짐.
...
```bash
git add meeple-infra/src/main/kotlin/com/org/meeple/infra/match/query/GetExpiredMatchDaoImpl.kt meeple-infra/src/main/kotlin/com/org/meeple/infra/match/command/adapter/ExpireMatchBridgeAdapter.kt
...
**Files:**
- Create: `meeple-api/src/main/kotlin/com/org/meeple/scheduler/match/ExpireMatchBatchScheduler.kt`
...
import com.org.meeple.scheduler.match.command.adapter.ExpireMatchBatchJob
...
`application.yml`의 운영 `meeple.match` 블록(`team-match-batch` 다음, 73~75줄 부근)에:
...
`application.yml`의 `local` 프로파일 `meeple.match` 블록(`team-match-batch` 다음, 112~114줄 부근)에:
...
```bash
git add meeple-api/src/main/kotlin/com/org/meeple/scheduler/match/ExpireMatchBatchScheduler.kt meeple-api/src/main/resources/application.yml
...
**Files:**
- Test: `meeple-api/src/test/kotlin/com/org/meeple/api/scheduler/RunExpireMatchBatchIntegrationTest.kt` (신규)
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.api.scheduler.RunExpireMatchBatchIntegrationTest"`
Expected: PASS

- [ ] **Step 3: 커밋**

```bash
git add meeple-api/src/test/kotlin/com/org/meeple/api/scheduler/RunExpireMatchBatchIntegrationTest.kt
...
**Files:**
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/match/command/entity/SoloMatchEntity.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/match/command/entity/TeamMatchEntity.kt`
...
Run: `./gradlew :meeple-infra:compileKotlin && ./gradlew :meeple-api:test --tests "com.org.meeple.api.scheduler.RunExpireMatchBatchIntegrationTest"`
Expected: PASS

- [ ] **Step 5: 커밋**

```bash
git add meeple-infra docs/migration/match_expires_at_indexes.sql
