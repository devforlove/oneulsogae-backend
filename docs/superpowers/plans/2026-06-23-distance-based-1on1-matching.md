...
**Files:**
- Create: `oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/region/RegionProximity.kt`
- Test: `oneulsogae-api/src/test/kotlin/com/org/oneulsogae/region/RegionProximityTest.kt`
...
```kotlin
package com.org.oneulsogae.region

import com.org.oneulsogae.infra.region.RegionPoint
import com.org.oneulsogae.infra.region.RegionProximity
...
Run: `./gradlew :oneulsogae-api:test --tests "com.org.oneulsogae.region.RegionProximityTest"`
...
```bash
git add oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/region/RegionProximity.kt \
        oneulsogae-api/src/test/kotlin/com/org/oneulsogae/region/RegionProximityTest.kt
...
**Files:**
- Create: `oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/region/RegionProximityRegistry.kt`
...
import com.org.oneulsogae.infra.region.repository.RegionJpaRepository
...
```bash
git add oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/region/RegionProximityRegistry.kt
...
**Files:**
- Create: `oneulsogae-scheduler/src/main/kotlin/com/org/oneulsogae/scheduler/match/command/application/port/out/RegionProximityPort.kt`
- Create: `oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/match/command/adapter/RegionProximityAdapter.kt`
 ...
 * 구현은 infra 레이어가 [com.org.oneulsogae.infra.region.RegionProximityRegistry] 위임으로 담당한다.
 */
...
import com.org.oneulsogae.infra.region.RegionProximityRegistry
...
```bash
git add oneulsogae-scheduler/src/main/kotlin/com/org/oneulsogae/scheduler/match/command/application/port/out/RegionProximityPort.kt \
        oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/match/command/adapter/RegionProximityAdapter.kt
...
**Files:**
- Modify: `oneulsogae-scheduler/.../command/application/port/out/MatchPoolPort.kt`
- Modify: `oneulsogae-scheduler/.../command/application/port/out/SaveMatchPoolPort.kt`
- Modify: `oneulsogae-scheduler/.../command/domain/MatchPoolGroup.kt`
- Delete: `oneulsogae-scheduler/.../command/domain/MatchPoolByGender.kt`
- Modify: `oneulsogae-infra/.../match/command/adapter/MatchRedisAdapter.kt`
...
import com.org.oneulsogae.scheduler.match.command.domain.MatchPoolGroup
...
import com.org.oneulsogae.common.user.Gender
import com.org.oneulsogae.scheduler.match.query.dto.ActiveUser
...
```bash
git rm oneulsogae-scheduler/src/main/kotlin/com/org/oneulsogae/scheduler/match/command/domain/MatchPoolByGender.kt
```
...
import com.org.oneulsogae.common.user.Gender
import com.org.oneulsogae.scheduler.match.command.application.port.out.MatchPoolPort
import com.org.oneulsogae.scheduler.match.command.application.port.out.SaveMatchPoolPort
import com.org.oneulsogae.scheduler.match.command.domain.MatchPoolGroup
...
```bash
git add -A oneulsogae-scheduler/src/main/kotlin/com/org/oneulsogae/scheduler/match/command/domain \
          oneulsogae-scheduler/src/main/kotlin/com/org/oneulsogae/scheduler/match/command/application/port/out \
...
**Files:**
- Modify: `oneulsogae-scheduler/.../query/dto/ActiveUser.kt`
- Modify: `oneulsogae-scheduler/.../query/dto/MatchBatchTarget.kt`
- Modify: `oneulsogae-infra/.../user/query/GetActiveUserDaoImpl.kt`
- Modify: `oneulsogae-infra/.../match/query/GetMatchBatchTargetDaoImpl.kt`
...
```bash
git add oneulsogae-scheduler/src/main/kotlin/com/org/oneulsogae/scheduler/match/query/dto/ActiveUser.kt \
...
**Files:**
- Modify: `oneulsogae-scheduler/.../command/application/MatchIntroducer.kt`
- Test: `oneulsogae-api/src/test/kotlin/com/org/oneulsogae/scheduler/match/MatchIntroducerTest.kt`
...
import com.org.oneulsogae.common.user.Gender
import com.org.oneulsogae.scheduler.match.command.application.MatchIntroducer
import com.org.oneulsogae.scheduler.match.command.application.port.out.MatchPoolPort
import com.org.oneulsogae.scheduler.match.command.application.port.out.RegionProximityPort
...
Run: `./gradlew :oneulsogae-api:test --tests "com.org.oneulsogae.scheduler.match.MatchIntroducerTest"`
...
```bash
git add oneulsogae-scheduler/src/main/kotlin/com/org/oneulsogae/scheduler/match/command/application/MatchIntroducer.kt \
...
**Files:**
- Modify: `oneulsogae-scheduler/.../command/application/RunDailyMatchBatchService.kt`
...
생성자 파라미터에 `private val regionProximityPort: RegionProximityPort,` 를 `saveMatchPoolPort` 다음에 추가하고, 상단 import에서 `com.org.oneulsogae.scheduler.match.command.domain.MatchPoolByGender` 를 제거, `com.org.oneulsogae.scheduler.match.command.application.port.out.RegionProximityPort` 를 추가한다.
...
```bash
git add oneulsogae-scheduler/src/main/kotlin/com/org/oneulsogae/scheduler/match/command/application/RunDailyMatchBatchService.kt
...
**Files:**
- Modify: `oneulsogae-core/.../command/application/port/out/GetMatchCandidatePort.kt`
- Modify: `oneulsogae-infra/.../match/command/repository/MatchUserJpaRepository.kt`
- Modify: `oneulsogae-infra/.../match/command/adapter/MatchUserAdapter.kt`
- Modify: `oneulsogae-core/.../command/application/RecommendMatchService.kt`
...
import com.org.oneulsogae.common.user.Gender
import com.org.oneulsogae.core.match.command.application.port.out.DeleteMatchUserPort
import com.org.oneulsogae.core.match.command.application.port.out.GetMatchCandidatePort
import com.org.oneulsogae.core.match.command.application.port.out.GetMatchUserPort
import com.org.oneulsogae.core.match.command.application.port.out.SaveMatchUserPort
import com.org.oneulsogae.core.match.command.domain.MatchUser
import com.org.oneulsogae.infra.match.command.entity.MatchUserEntity
import com.org.oneulsogae.infra.match.command.mapper.applyFrom
...
import com.org.oneulsogae.infra.match.command.repository.MatchUserJpaRepository
import com.org.oneulsogae.infra.region.RegionProximityRegistry
...
```bash
git add oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/match/command/application/port/out/GetMatchCandidatePort.kt \
        oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/match/command/application/RecommendMatchService.kt \
        oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/match/command/repository/MatchUserJpaRepository.kt \
        oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/match/command/adapter/MatchUserAdapter.kt
...
**Files:**
- Modify: `oneulsogae-infra/.../match/command/entity/MatchUserEntity.kt`
...
```bash
git add oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/match/command/entity/MatchUserEntity.kt \
...
**Files:**
- Modify: `oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/scheduler/RunDailyMatchBatchIntegrationTest.kt`
...
Run: `./gradlew :oneulsogae-api:test --tests "com.org.oneulsogae.api.scheduler.RunDailyMatchBatchIntegrationTest"`
Expected: PASS (Testcontainers MySQL/Redis 기동)

- [ ] **Step 6: 커밋**

```bash
git add oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/scheduler/RunDailyMatchBatchIntegrationTest.kt
...
**Files:**
- Create: `oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/match/GetMatchCandidateIntegrationTest.kt`
...
Run: `./gradlew :oneulsogae-api:test --tests "com.org.oneulsogae.api.match.GetMatchCandidateIntegrationTest"`
Expected: PASS
...
```bash
git add oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/match/GetMatchCandidateIntegrationTest.kt
