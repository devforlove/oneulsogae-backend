...
- 도메인 유닛 테스트 위치: `meeple-api/src/test/kotlin/com/org/meeple/domain/match/`. api E2E: `meeple-api/src/test/kotlin/com/org/meeple/api/match/` (`AbstractIntegrationSupport` 상속).
...
- Test: `meeple-api/src/test/kotlin/com/org/meeple/domain/match/MatchedTeamsTest.kt` (기존 파일에 추가)
...
**Files:**
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/match/TeamMatchErrorCode.kt`
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/match/command/domain/TeamMatch.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/domain/match/TeamMatchTest.kt` (기존 파일에 추가)
...
- [ ] **Step 2: 실패하는 테스트 작성** (`TeamMatchTest.kt`의 `DescribeSpec` 블록 안, 기존 `describe("isMatched")` 아래에 추가. 상단 import에 `import com.org.meeple.core.common.error.BusinessException`, `import com.org.meeple.core.match.TeamMatchErrorCode`, `import io.kotest.assertions.throwables.shouldThrow`, `import io.kotest.matchers.shouldNotBe` 추가)
...
> 참고: `BusinessException`의 에러코드 프로퍼티명이 `errorCode`가 맞는지 `meeple-core/.../common/error/BusinessException.kt`에서 확인하고, 다르면 단언 프로퍼티명을 맞춘다.
...
```bash
git add meeple-core/src/main/kotlin/com/org/meeple/core/match/TeamMatchErrorCode.kt \
...
**Files:**
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/match/command/application/port/out/GetTeamMatchPort.kt`
...
**Files:**
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/match/command/domain/event/TeamMatchInterestSent.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/match/command/domain/event/TeamMatchAccepted.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/match/command/application/port/in/SendTeamInterestUseCase.kt`
...
```bash
git add meeple-core/src/main/kotlin/com/org/meeple/core/match/command/domain/event/TeamMatchInterestSent.kt \
        meeple-core/src/main/kotlin/com/org/meeple/core/match/command/domain/event/TeamMatchAccepted.kt \
        meeple-core/src/main/kotlin/com/org/meeple/core/match/command/application/port/in/SendTeamInterestUseCase.kt \
        meeple-core/src/main/kotlin/com/org/meeple/core/common/lock/LockKeyConstraints.kt
...
**Files:**
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/match/command/application/SendTeamInterestService.kt`

**Interfaces:**
- Consumes:
  - `GetTeamMatchPort.findById` (Task 3), `SaveTeamMatchPort.save`
  - `GetTeamPort.findById` (`com.org.meeple.core.match.command.application.port.out.GetTeamPort`)
...
**Files:**
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/match/command/application/TeamMatchEventHandler.kt`
...
```bash
git add meeple-core/src/main/kotlin/com/org/meeple/core/match/command/application/TeamMatchEventHandler.kt
...
**Files:**
- Create: `meeple-api/src/main/kotlin/com/org/meeple/api/match/TeamMatchController.kt`
- Create: `meeple-api/src/main/kotlin/com/org/meeple/api/match/response/TeamMatchResponse.kt`
...
git add meeple-api/src/main/kotlin/com/org/meeple/api/match/TeamMatchController.kt \
        meeple-api/src/main/kotlin/com/org/meeple/api/match/response/TeamMatchResponse.kt
...
**Files:**
- Create: `meeple-api/src/test/kotlin/com/org/meeple/api/match/SendTeamInterestE2ETest.kt`
...
```bash
git add meeple-api/src/test/kotlin/com/org/meeple/api/match/SendTeamInterestE2ETest.kt
