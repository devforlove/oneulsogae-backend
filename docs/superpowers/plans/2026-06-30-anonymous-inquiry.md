...
**Files:**
- Modify: `oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/inquiry/command/domain/Inquiry.kt`
- Modify: `oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/inquiry/command/application/port/in/command/CreateInquiryCommand.kt`
...
```bash
git add oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/inquiry oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/inquiry oneulsogae-api/src/test/kotlin/com/org/oneulsogae/domain/inquiry docs/migration/inquiries_user_id_nullable.sql
...
**Files:**
- Modify: `oneulsogae-api/src/main/kotlin/com/org/oneulsogae/config/SecurityConfig.kt`
- Modify: `oneulsogae-api/src/main/kotlin/com/org/oneulsogae/api/inquiry/InquiryController.kt`
- Modify: `oneulsogae-api/src/main/kotlin/com/org/oneulsogae/api/inquiry/request/CreateInquiryRequest.kt`
...
Run: `./gradlew :oneulsogae-api:test --tests "com.org.oneulsogae.api.inquiry.*" --tests "com.org.oneulsogae.domain.inquiry.*"`
Expected: PASS.

- [ ] **Step 8: 커밋**

```bash
git add oneulsogae-api/src/main/kotlin/com/org/oneulsogae/config/SecurityConfig.kt oneulsogae-api/src/main/kotlin/com/org/oneulsogae/api/inquiry oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/inquiry
