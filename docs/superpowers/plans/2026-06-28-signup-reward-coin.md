...
### Task 1: 코인 적립 유형·정책 상수 추가 (oneulsogae-common)
...
```bash
git add oneulsogae-common/src/main/kotlin/com/org/oneulsogae/common/coin/CoinGetType.kt \
        oneulsogae-common/src/main/kotlin/com/org/oneulsogae/common/coin/CoinPolicy.kt
...
**Files:**
- Modify: `oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/user/command/application/port/in/result/VerifyCompanyEmailResult.kt`
- Modify: `oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/user/command/application/VerifyCompanyEmailService.kt`
- Modify: `oneulsogae-api/src/main/kotlin/com/org/oneulsogae/api/user/response/VerifyCompanyEmailResponse.kt`
- Test: `oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/user/ConfirmCompanyEmailVerificationE2ETest.kt`
...
Run: `./gradlew :oneulsogae-api:test --tests "com.org.oneulsogae.api.user.ConfirmCompanyEmailVerificationE2ETest"`
...
Run: `grep -rn "VerifyCompanyEmailResult(" oneulsogae-*/src --include=*.kt`
...
```bash
git add oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/user/command/application/port/in/result/VerifyCompanyEmailResult.kt \
        oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/user/command/application/VerifyCompanyEmailService.kt \
        oneulsogae-api/src/main/kotlin/com/org/oneulsogae/api/user/response/VerifyCompanyEmailResponse.kt \
        oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/user/ConfirmCompanyEmailVerificationE2ETest.kt
...
**Files:**
- Modify: `oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/user/command/application/UserEventHandler.kt`
- Modify: `oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/user/OnboardingE2ESupport.kt`
- Test: `oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/user/ConfirmCompanyEmailVerificationE2ETest.kt`
- Test: `oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/user/ResolveCompanyNameE2ETest.kt`
...
필요 import 확인(없으면 추가): `import com.org.oneulsogae.infra.fixture.CoinBalanceEntityFixture`.
...
Run: `./gradlew :oneulsogae-api:test --tests "com.org.oneulsogae.api.user.ResolveCompanyNameE2ETest"`
Expected: PASS

- [ ] **Step 8: Commit**

```bash
git add oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/user/command/application/UserEventHandler.kt \
        oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/user/OnboardingE2ESupport.kt \
        oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/user/ConfirmCompanyEmailVerificationE2ETest.kt \
        oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/user/ResolveCompanyNameE2ETest.kt
