...
**Architecture:** 헥사고날. core `gathering` 도메인에 command(참가 등록: 검증·여분 차감·PENDING insert)를 신설하고, core `payments` command가 그 in-port를 호출해 결제 기록을 남긴다. 운영자 승인/거절/목록은 자립 모듈 `meeple-admin`의 자체 도메인·포트로 구현하고 infra 어댑터가 잇는다.
...
- 테스트 실행: `./gradlew :meeple-api:test --tests "<FQCN>"` (E2E는 Docker 필요).
...
**Files:**
- Modify: `meeple-common/src/main/kotlin/com/org/meeple/common/gathering/GatheringMemberStatus.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/entity/GatheringMemberEntity.kt`
- Create: `docs/migration/gathering_members_schedule_id_gender.sql`
- Create: `meeple-infra/src/testFixtures/kotlin/com/org/meeple/infra/fixture/GatheringMemberEntityFixture.kt`
...
`meeple-infra/src/testFixtures/kotlin/com/org/meeple/infra/fixture/GatheringMemberEntityFixture.kt` 생성:
...
Run: `./gradlew :meeple-common:compileKotlin :meeple-infra:compileKotlin :meeple-infra:compileTestFixturesKotlin`
Expected: BUILD SUCCESSFUL

- [ ] **Step 6: Commit**

```bash
git add meeple-common meeple-infra docs/migration/gathering_members_schedule_id_gender.sql
...
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/domain/JoiningSchedule.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/domain/JoinPricing.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/domain/GatheringMember.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/JoiningScheduleTest.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/GatheringMemberTest.kt`
...
`meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/JoiningScheduleTest.kt` 생성:
...
`meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/domain/JoinPricing.kt` 생성:
...
`meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/domain/JoiningSchedule.kt` 생성:
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.domain.gathering.JoiningScheduleTest"`
Expected: PASS

- [ ] **Step 6: GatheringMember 실패 테스트 작성**

`meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/GatheringMemberTest.kt` 생성:
...
`meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/domain/GatheringMember.kt` 생성:
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.domain.gathering.GatheringMemberTest" --tests "com.org.meeple.domain.gathering.JoiningScheduleTest"`
Expected: PASS

- [ ] **Step 9: Commit**

```bash
git add meeple-core meeple-api/src/test/kotlin/com/org/meeple/domain/gathering
...
**Files:**
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/application/port/in/RegisterGatheringMemberUseCase.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/application/port/in/command/RegisterGatheringMemberCommand.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/application/port/in/result/RegisterGatheringMemberResult.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/application/port/out/GetJoiningSchedulePort.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/application/port/out/SaveJoiningSchedulePort.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/application/port/out/LoadGatheringMemberPort.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/application/port/out/SaveGatheringMemberPort.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/application/RegisterGatheringMemberService.kt`
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/repository/GatheringMemberJpaRepository.kt`
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/mapper/GatheringMemberMapper.kt`
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/adapter/GatheringMemberAdapter.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/repository/GatheringScheduleJpaRepository.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/adapter/GatheringScheduleAdapter.kt`
...
```bash
git add meeple-core meeple-infra
...
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/payments/command/domain/Payment.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/payments/command/application/port/in/CompletePaymentUseCase.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/payments/command/application/port/in/command/CompletePaymentCommand.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/payments/command/application/port/in/result/CompletePaymentResult.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/payments/command/application/port/out/SavePaymentPort.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/payments/command/application/CompletePaymentService.kt`
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/payments/command/entity/PaymentEntity.kt`
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/payments/command/repository/PaymentJpaRepository.kt`
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/payments/command/adapter/PaymentAdapter.kt`
...
**Files:**
- Create: `meeple-api/src/main/kotlin/com/org/meeple/api/payments/request/CompletePaymentRequest.kt`
- Create: `meeple-api/src/main/kotlin/com/org/meeple/api/payments/response/CompletePaymentResponse.kt`
- Modify: `meeple-api/src/main/kotlin/com/org/meeple/api/payments/PaymentsController.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/api/payments/PaymentsCompleteE2ETest.kt`
...
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/domain/AdminGatheringMember.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/application/port/in/ApproveGatheringMemberUseCase.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/application/port/in/RejectGatheringMemberUseCase.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/application/port/out/LoadAdminGatheringMemberPort.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/application/port/out/ChangeGatheringMemberStatusPort.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/application/port/out/RestoreGatheringMemberSeatPort.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/application/ApproveGatheringMemberService.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/application/RejectGatheringMemberService.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/adapter/GatheringMemberAdapter.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/adapter/GatheringScheduleAdapter.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/AdminGatheringMemberTest.kt`
...
`meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/AdminGatheringMemberTest.kt` 생성:
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.domain.gathering.AdminGatheringMemberTest"`
Expected: PASS
...
Run: `./gradlew :meeple-admin:compileKotlin :meeple-infra:compileKotlin`
Expected: BUILD SUCCESSFUL

- [ ] **Step 8: Commit**

```bash
git add meeple-admin meeple-infra meeple-api/src/test/kotlin/com/org/meeple/domain/gathering
...
**Files:**
- Create: `meeple-api/src/main/kotlin/com/org/meeple/api/admin/AdminGatheringMemberController.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/admin/gathering/AdminGatheringMemberE2ETest.kt`
...
`meeple-api/src/test/kotlin/com/org/meeple/admin/gathering/AdminGatheringMemberE2ETest.kt` 생성:
...
> 어드민 에러 응답 JSON 경로(`error.code`)와 403 검증 형식은 기존 어드민 E2E(예: `meeple-api/src/test/kotlin/com/org/meeple/admin/gathering/` 하위)를 열어 실제 형식에 맞춘다.

- [ ] **Step 2: 테스트 실패 확인**

Run: `./gradlew :meeple-api:test --tests "com.org.meeple.admin.gathering.AdminGatheringMemberE2ETest"`
Expected: FAIL — 404 (엔드포인트 없음)
...
**Files:**
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/query/dao/GetAdminGatheringMemberDao.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/query/dto/AdminGatheringMemberView.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/query/dto/AdminGatheringMemberViews.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/query/service/GetAdminGatheringMembersService.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/query/service/port/in/GetAdminGatheringMembersUseCase.kt`
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/query/GetAdminGatheringMemberDaoImpl.kt`
- Create: `meeple-api/src/main/kotlin/com/org/meeple/api/admin/response/AdminGatheringMemberResponse.kt`
- Modify: `meeple-api/src/main/kotlin/com/org/meeple/api/admin/AdminGatheringMemberController.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/admin/gathering/AdminGatheringMemberListE2ETest.kt`
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.admin.gathering.AdminGatheringMemberListE2ETest"`
Expected: FAIL — 404 (엔드포인트 없음)
...
`meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/query/GetAdminGatheringMemberDaoImpl.kt`:
...
`meeple-api/src/main/kotlin/com/org/meeple/api/admin/response/AdminGatheringMemberResponse.kt`:
