...
**Architecture:** `meeple-admin`의 self-contained 헥사고날 패턴(`companyverification` 미러링)으로 어드민 전용 query/command 컴포넌트를 신설하고, 기존 `notices` 테이블/`NoticeEntity`/`QNoticeEntity`를 재사용한다. 영속성은 `meeple-infra`의 DaoImpl(조회)·Adapter(저장)가 어드민 out-port를 구현하고, HTTP 경계(Controller/DTO)는 `meeple-api`에 둔다.
...
- 어드민 모듈(`meeple-admin`)은 core에 의존하지 않는다(self-contained). core `Notice`/`NoticeView` 등을 import하지 않는다.
- 타입 명시: 변수·반환 타입·람다 파라미터 타입 생략 금지.
- `LocalDateTime.now()` 직접 호출 금지(이 기능은 created_at을 JPA Auditing이 채우므로 시각 직접 생성 없음).
- 컨트롤러는 core `com.org.meeple.core.common.response.ApiResponse`를 반환(기존 어드민 컨트롤러 규약).
...
**패키지 루트:** `com.org.meeple.admin.notice` (admin), `com.org.meeple.infra.notice` (infra), `com.org.meeple.api.admin` (api).
...
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/notice/query/dto/AdminNoticeView.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/notice/query/dto/AdminNoticeViews.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/notice/query/dto/AdminNoticeDetailView.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/notice/query/dto/AdminNoticePage.kt`
...
```bash
git add meeple-admin/src/main/kotlin/com/org/meeple/admin/common/error/AdminErrorCode.kt \
  meeple-admin/src/main/kotlin/com/org/meeple/admin/notice/query/dto/
...
**Files:**
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/notice/query/dao/GetAdminNoticeDao.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/notice/query/service/port/in/GetAdminNoticesUseCase.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/notice/query/service/GetAdminNoticesService.kt`
...
```kotlin
package com.org.meeple.admin.notice.query.service.port.`in`
...
```kotlin
package com.org.meeple.admin.notice.query.service
...
import com.org.meeple.admin.notice.query.dto.AdminNoticePage
import com.org.meeple.admin.notice.query.dto.AdminNoticeViews
import com.org.meeple.admin.notice.query.service.port.`in`.GetAdminNoticesUseCase
...
```bash
git add meeple-admin/src/main/kotlin/com/org/meeple/admin/notice/query/dao/ \
  meeple-admin/src/main/kotlin/com/org/meeple/admin/notice/query/service/
...
**Files:**
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/notice/query/GetAdminNoticeDaoImpl.kt`
...
> 참고: `meeple-infra`는 이미 `meeple-admin`에 의존한다(`GetAdminCompanyVerificationDaoImpl`이 어드민 포트를 구현 중). 별도 의존성 추가 불필요. `QNoticeEntity`는 기존 `NoticeEntity`에서 이미 생성된다.
...
```bash
git add meeple-infra/src/main/kotlin/com/org/meeple/infra/notice/query/GetAdminNoticeDaoImpl.kt
...
**Files:**
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/notice/command/domain/AdminNotice.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/notice/command/application/port/in/command/CreateAdminNoticeCommand.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/notice/command/application/port/in/CreateAdminNoticeUseCase.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/notice/command/application/port/out/SaveAdminNoticePort.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/notice/command/application/CreateAdminNoticeService.kt`
...
```kotlin
package com.org.meeple.admin.notice.command.application.port.`in`
...
```bash
git add meeple-admin/src/main/kotlin/com/org/meeple/admin/notice/command/
...
**Files:**
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/notice/command/mapper/AdminNoticeMapper.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/notice/command/adapter/NoticeAdapter.kt`
 ...
 * 공지 조회는 [com.org.meeple.infra.notice.query.GetNoticeDaoImpl]·[com.org.meeple.infra.notice.query.GetAdminNoticeDaoImpl]가 따로 담당한다.
 */
@Component
class NoticeAdapter(
...
```bash
git add meeple-infra/src/main/kotlin/com/org/meeple/infra/notice/command/mapper/AdminNoticeMapper.kt \
  meeple-infra/src/main/kotlin/com/org/meeple/infra/notice/command/adapter/NoticeAdapter.kt
...
**Files:**
- Create: `meeple-api/src/main/kotlin/com/org/meeple/api/admin/request/CreateAdminNoticeRequest.kt`
- Create: `meeple-api/src/main/kotlin/com/org/meeple/api/admin/response/AdminNoticeResponse.kt`
- Create: `meeple-api/src/main/kotlin/com/org/meeple/api/admin/response/AdminNoticePageResponse.kt`
- Create: `meeple-api/src/main/kotlin/com/org/meeple/api/admin/response/AdminNoticeDetailResponse.kt`
- Create: `meeple-api/src/main/kotlin/com/org/meeple/api/admin/AdminNoticeController.kt`
- Create: `meeple-api/src/test/kotlin/com/org/meeple/api/admin/AdminNoticeE2ETest.kt`
- Create: `meeple-api/src/test/kotlin/com/org/meeple/domain/notice/AdminNoticePageTest.kt`
...
`meeple-api/src/test/kotlin/com/org/meeple/api/admin/AdminNoticeE2ETest.kt`:
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.api.admin.AdminNoticeE2ETest" -q`
...
import com.org.meeple.admin.notice.command.application.port.`in`.CreateAdminNoticeUseCase
import com.org.meeple.admin.notice.query.service.port.`in`.GetAdminNoticesUseCase
import com.org.meeple.api.admin.request.CreateAdminNoticeRequest
import com.org.meeple.api.admin.response.AdminNoticeDetailResponse
import com.org.meeple.api.admin.response.AdminNoticePageResponse
...
`meeple-api/src/test/kotlin/com/org/meeple/domain/notice/AdminNoticePageTest.kt`:
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.domain.notice.AdminNoticePageTest" -q`
Expected: PASS

- [ ] **Step 11: 전체 관련 테스트 재확인 + Commit**

Run: `./gradlew :meeple-api:test --tests "com.org.meeple.api.admin.AdminNoticeE2ETest" --tests "com.org.meeple.domain.notice.AdminNoticePageTest" -q`
Expected: PASS

```bash
git add meeple-api/src/main/kotlin/com/org/meeple/api/admin/ \
  meeple-api/src/test/kotlin/com/org/meeple/api/admin/AdminNoticeE2ETest.kt \
  meeple-api/src/test/kotlin/com/org/meeple/domain/notice/AdminNoticePageTest.kt
