...
| 파일 | 책임 | Task |
|---|---|---|
| `oneulsogae-core/.../match/query/dto/SentInvitation.kt` | read model (`SentInvitation`, `SentInvitationMember`) | 1 |
| `oneulsogae-core/.../match/query/service/port/in/GetSentInvitationUseCase.kt` | in-port | 1 |
| `oneulsogae-core/.../match/query/dao/GetSentInvitationDao.kt` | query out-port | 1 |
| `oneulsogae-core/.../match/query/service/GetSentInvitationService.kt` | UseCase 구현 | 1 |
| `oneulsogae-infra/.../match/query/GetSentInvitationDaoImpl.kt` | QueryDSL 구현 | 1 |
| `oneulsogae-api/.../match/response/SentInvitationResponse.kt` | 응답 DTO | 2 |
| `oneulsogae-api/.../match/TeamController.kt` | `getSentInvitation()` 메서드 추가 | 2 |
| `oneulsogae-api/.../test/.../match/GetSentInvitationE2ETest.kt` | E2E 테스트 | 2 |
...
**Files:**
- Create: `oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/match/query/dto/SentInvitation.kt`
- Create: `oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/match/query/service/port/in/GetSentInvitationUseCase.kt`
- Create: `oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/match/query/dao/GetSentInvitationDao.kt`
- Create: `oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/match/query/service/GetSentInvitationService.kt`
- Create: `oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/match/query/GetSentInvitationDaoImpl.kt`
...
`oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/match/query/dto/SentInvitation.kt`:
...
`oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/match/query/service/port/in/GetSentInvitationUseCase.kt`:

```kotlin
package com.org.oneulsogae.core.match.query.service.port.`in`

import com.org.oneulsogae.core.match.query.dto.SentInvitation
...
`oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/match/query/dao/GetSentInvitationDao.kt`:
...
`oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/match/query/service/GetSentInvitationService.kt`:

```kotlin
package com.org.oneulsogae.core.match.query.service

import com.org.oneulsogae.core.match.query.dao.GetSentInvitationDao
import com.org.oneulsogae.core.match.query.dto.SentInvitation
import com.org.oneulsogae.core.match.query.service.port.`in`.GetSentInvitationUseCase
...
`oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/match/query/GetSentInvitationDaoImpl.kt`:
...
import com.org.oneulsogae.core.match.query.dao.GetSentInvitationDao
import com.org.oneulsogae.core.match.query.dto.SentInvitation
import com.org.oneulsogae.core.match.query.dto.SentInvitationMember
...
Expected: BUILD SUCCESSFUL (oneulsogae-infra는 core에 의존하므로 core query 슬라이스도 함께 컴파일된다)
...
**Files:**
- Create: `oneulsogae-api/src/main/kotlin/com/org/oneulsogae/api/match/response/SentInvitationResponse.kt`
- Modify: `oneulsogae-api/src/main/kotlin/com/org/oneulsogae/api/match/TeamController.kt`
- Create (test): `oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/match/GetSentInvitationE2ETest.kt`
...
`oneulsogae-api/src/main/kotlin/com/org/oneulsogae/api/match/response/SentInvitationResponse.kt`:
...
(상단 import에 `import com.org.oneulsogae.core.match.query.dto.SentInvitationMember` 추가)
...
1. import 추가:
```kotlin
import com.org.oneulsogae.api.match.response.SentInvitationResponse
import com.org.oneulsogae.core.match.query.service.port.`in`.GetSentInvitationUseCase
```
...
`oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/match/GetSentInvitationE2ETest.kt`:
...
Run: `./gradlew :oneulsogae-api:test --tests "com.org.oneulsogae.api.match.GetSentInvitationE2ETest"`
Expected: BUILD SUCCESSFUL — 5개 테스트(초대자 조회 / 초대받은 유저 null / 초대 없음 null / 철회 후 null / 미인증 401) 모두 PASS

- [ ] **Step 5: Commit**

```bash
git add oneulsogae-api/src/main/kotlin/com/org/oneulsogae/api/match/response/SentInvitationResponse.kt \
