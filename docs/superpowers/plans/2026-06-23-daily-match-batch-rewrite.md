...
```bash
git add meeple-infra/src/main/kotlin/com/org/meeple/infra/match/command/entity/SoloMatchEntity.kt \
...
**Files:**
- Create: `meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/query/dto/MatchableUser.kt`
...
```bash
git add meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/query/dto/MatchableUser.kt
...
**Files:**
- Create: `meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/command/domain/MatchPool.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/scheduler/match/MatchPoolTest.kt`
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.scheduler.match.MatchPoolTest"`
...
```bash
git add meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/command/domain/MatchPool.kt \
        meeple-api/src/test/kotlin/com/org/meeple/scheduler/match/MatchPoolTest.kt
...
**Files:**
- Create: `meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/query/dao/GetMatchableUserDao.kt`
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/match/query/GetMatchableUserDaoImpl.kt`
...
```bash
git add meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/query/dao/GetMatchableUserDao.kt \
        meeple-infra/src/main/kotlin/com/org/meeple/infra/match/query/GetMatchableUserDaoImpl.kt
...
**Files:**
- Modify: `meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/query/dao/GetMatchRecordDao.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/match/query/GetMatchRecordDaoImpl.kt`
...
```bash
git add meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/query/dao/GetMatchRecordDao.kt \
        meeple-infra/src/main/kotlin/com/org/meeple/infra/match/query/GetMatchRecordDaoImpl.kt
...
**Files:**
- Create: `meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/command/application/DailyMatchBatchService.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/scheduler/match/DailyMatchBatchServiceTest.kt`
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.scheduler.match.DailyMatchBatchServiceTest"`
...
```bash
git add meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/command/application/DailyMatchBatchService.kt \
        meeple-api/src/test/kotlin/com/org/meeple/scheduler/match/DailyMatchBatchServiceTest.kt
...
**Files:**
- Delete: `meeple-scheduler/.../command/application/RunDailyMatchBatchService.kt`
- Delete: `meeple-scheduler/.../command/application/MatchIntroducer.kt`
- Delete: `meeple-api/src/test/kotlin/com/org/meeple/scheduler/match/MatchIntroducerTest.kt`
- Delete: `meeple-scheduler/.../command/application/port/out/MatchPoolPort.kt`
- Delete: `meeple-scheduler/.../command/application/port/out/SaveMatchPoolPort.kt`
- Delete: `meeple-scheduler/.../command/domain/MatchPoolGroup.kt`
- Delete: `meeple-infra/.../match/command/adapter/MatchRedisAdapter.kt`
- Delete: `meeple-scheduler/.../query/dao/GetMatchBatchTargetDao.kt`
- Delete: `meeple-infra/.../match/query/GetMatchBatchTargetDaoImpl.kt`
- Delete: `meeple-scheduler/.../query/dao/GetActiveUserDao.kt`
- Delete: `meeple-infra/.../user/query/GetActiveUserDaoImpl.kt`
- Delete: `meeple-scheduler/.../query/dto/MatchBatchTarget.kt`
- Delete: `meeple-scheduler/.../query/dto/MatchBatchCursor.kt`
- Delete: `meeple-scheduler/.../query/dto/ActiveUser.kt`
- Modify: `meeple-scheduler/.../command/application/DailyMatchBatchService.kt` (add `@Service`)
- Modify: `meeple-scheduler/.../query/dto/MatchedUserIds.kt` (drop `exclude(List<ActiveUser>)` + import)
- Rewrite: `meeple-api/src/test/kotlin/com/org/meeple/api/scheduler/RunDailyMatchBatchIntegrationTest.kt`
...
git rm \
  meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/command/application/RunDailyMatchBatchService.kt \
  meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/command/application/MatchIntroducer.kt \
  meeple-api/src/test/kotlin/com/org/meeple/scheduler/match/MatchIntroducerTest.kt \
  meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/command/application/port/out/MatchPoolPort.kt \
  meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/command/application/port/out/SaveMatchPoolPort.kt \
  meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/command/domain/MatchPoolGroup.kt \
  meeple-infra/src/main/kotlin/com/org/meeple/infra/match/command/adapter/MatchRedisAdapter.kt \
  meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/query/dao/GetMatchBatchTargetDao.kt \
  meeple-infra/src/main/kotlin/com/org/meeple/infra/match/query/GetMatchBatchTargetDaoImpl.kt \
  meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/query/dao/GetActiveUserDao.kt \
  ...
  meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/query/dto/MatchBatchCursor.kt \
  meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/query/dto/ActiveUser.kt
```
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.api.admin.AdminMatchBatchE2ETest"`
Expected: PASS

- [ ] **Step 3: 커밋**

```bash
git add meeple-api/src/main/resources/application.yml
