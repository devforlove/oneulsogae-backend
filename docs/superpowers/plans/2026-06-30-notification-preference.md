...
- 도메인 유닛 테스트는 **`meeple-api` 테스트 소스셋**(`meeple-api/src/test/kotlin/com/org/meeple/notification/`)에 둔다(core엔 testImplementation 없음). E2E도 `meeple-api`에 `AbstractIntegrationSupport` 상속으로 둔다.
...
**Files:**
- Create: `meeple-common/src/main/kotlin/com/org/meeple/common/notification/NotificationCategory.kt`
- Modify: `meeple-common/src/main/kotlin/com/org/meeple/common/alarm/AlarmType.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/notification/AlarmTypeCategoryTest.kt`
...
`meeple-api/src/test/kotlin/com/org/meeple/notification/AlarmTypeCategoryTest.kt`:
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.notification.AlarmTypeCategoryTest"`
Expected: 컴파일 실패(`NotificationCategory` / `category()` 미존재).

- [ ] **Step 3: NotificationCategory 생성**

`meeple-common/src/main/kotlin/com/org/meeple/common/notification/NotificationCategory.kt`:
...
```bash
git add meeple-common/src/main/kotlin/com/org/meeple/common/notification/NotificationCategory.kt \
        meeple-common/src/main/kotlin/com/org/meeple/common/alarm/AlarmType.kt \
        meeple-api/src/test/kotlin/com/org/meeple/notification/AlarmTypeCategoryTest.kt
...
**Files:**
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/notification/command/domain/NotificationPreference.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/notification/NotificationPreferenceTest.kt`
...
`meeple-api/src/test/kotlin/com/org/meeple/notification/NotificationPreferenceTest.kt`:
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.notification.NotificationPreferenceTest"`
Expected: 컴파일 실패(`NotificationPreference` 미존재).

- [ ] **Step 3: 도메인 모델 작성**

`meeple-core/src/main/kotlin/com/org/meeple/core/notification/command/domain/NotificationPreference.kt`:

```kotlin
package com.org.meeple.core.notification.command.domain
...
```bash
git add meeple-core/src/main/kotlin/com/org/meeple/core/notification/command/domain/NotificationPreference.kt \
        meeple-api/src/test/kotlin/com/org/meeple/notification/NotificationPreferenceTest.kt
...
**Files:**
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/notification/command/application/port/in/SaveNotificationPreferenceUseCase.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/notification/command/application/port/in/SendAlarmTalkUseCase.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/notification/command/application/port/in/command/SaveNotificationPreferenceCommand.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/notification/command/application/port/in/command/SendAlarmTalkCommand.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/notification/command/application/port/out/GetNotificationPreferencePort.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/notification/command/application/port/out/SaveNotificationPreferencePort.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/notification/command/application/port/out/AlarmTalkSenderPort.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/notification/query/dto/NotificationPreferenceView.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/notification/query/dao/GetNotificationPreferenceDao.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/notification/query/service/port/in/GetNotificationPreferenceUseCase.kt`
...
```kotlin
package com.org.meeple.core.notification.command.application.port.out
...
```kotlin
package com.org.meeple.core.notification.query.dto
...
```kotlin
package com.org.meeple.core.notification.query.service.port.`in`
...
```bash
git add meeple-core/src/main/kotlin/com/org/meeple/core/notification
...
**Files:**
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/notification/command/entity/NotificationPreferenceEntity.kt`
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/notification/command/mapper/NotificationPreferenceMapper.kt`
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/notification/command/repository/NotificationPreferenceJpaRepository.kt`
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/notification/command/adapter/NotificationPreferenceAdapter.kt`
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/notification/command/adapter/AlarmTalkSenderAdapter.kt`
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/notification/query/GetNotificationPreferenceDaoImpl.kt`
...
```kotlin
package com.org.meeple.infra.notification.command.mapper
...
import com.org.meeple.core.notification.command.application.port.out.AlarmTalkSenderPort
...
```kotlin
package com.org.meeple.infra.notification.query
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.api.alarm.*"`
Expected: 기존 알람 E2E PASS(컨텍스트 정상 기동 — 새 빈이 기존 동작을 깨지 않음).

- [ ] **Step 8: 커밋**

```bash
git add meeple-infra/src/main/kotlin/com/org/meeple/infra/notification
...
**Files:**
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/notification/command/application/SaveNotificationPreferenceService.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/notification/command/application/SendAlarmTalkService.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/notification/query/service/GetNotificationPreferenceService.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/notification/SendAlarmTalkServiceTest.kt`
...
`meeple-api/src/test/kotlin/com/org/meeple/notification/SendAlarmTalkServiceTest.kt`:

```kotlin
package com.org.meeple.notification

import com.org.meeple.common.alarm.AlarmType
import com.org.meeple.core.notification.command.application.SendAlarmTalkService
import com.org.meeple.core.notification.command.application.port.`in`.command.SendAlarmTalkCommand
import com.org.meeple.core.notification.command.application.port.out.AlarmTalkSenderPort
import com.org.meeple.core.notification.command.application.port.out.GetNotificationPreferencePort
import com.org.meeple.core.notification.command.domain.NotificationPreference
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.notification.SendAlarmTalkServiceTest"`
...
```kotlin
package com.org.meeple.core.notification.command.application
...
**Files:**
- Create: `meeple-api/src/main/kotlin/com/org/meeple/api/notification/NotificationPreferenceController.kt`
- Create: `meeple-api/src/main/kotlin/com/org/meeple/api/notification/request/UpdateNotificationPreferenceRequest.kt`
- Create: `meeple-api/src/main/kotlin/com/org/meeple/api/notification/response/NotificationPreferenceResponse.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/api/notification/NotificationPreferenceE2ETest.kt`
...
`meeple-api/src/test/kotlin/com/org/meeple/api/notification/NotificationPreferenceE2ETest.kt`:
...
import com.org.meeple.infra.notification.command.entity.QNotificationPreferenceEntity
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.api.notification.NotificationPreferenceE2ETest"`
...
```bash
git add meeple-api/src/main/kotlin/com/org/meeple/api/notification \
        meeple-api/src/test/kotlin/com/org/meeple/api/notification/NotificationPreferenceE2ETest.kt
...
**Files:**
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/alarm/command/application/SaveAlarmService.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/notification/SaveAlarmGateTest.kt`
...
`meeple-api/src/test/kotlin/com/org/meeple/notification/SaveAlarmGateTest.kt`:
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.notification.SaveAlarmGateTest"`
...
```bash
git add meeple-core/src/main/kotlin/com/org/meeple/core/alarm/command/application/SaveAlarmService.kt \
        meeple-api/src/test/kotlin/com/org/meeple/notification/SaveAlarmGateTest.kt
