...
**신규 파일**
- `meeple-common/.../common/user/DistancePreference.kt` — 거리 선호 enum
- `meeple-core/.../user/command/domain/UserIdealType.kt` — 도메인 모델 + 검증
- `meeple-core/.../user/command/application/port/in/SaveIdealTypeUseCase.kt`
- `meeple-core/.../user/command/application/port/in/command/SaveIdealTypeCommand.kt`
- `meeple-core/.../user/command/application/port/out/GetIdealTypePort.kt`
- `meeple-core/.../user/command/application/port/out/SaveIdealTypePort.kt`
- `meeple-core/.../user/command/application/SaveIdealTypeService.kt`
- `meeple-core/.../user/query/dto/IdealTypeView.kt`
- `meeple-core/.../user/query/dao/GetIdealTypeDao.kt`
- `meeple-core/.../user/query/service/port/in/GetIdealTypeUseCase.kt`
- `meeple-core/.../user/query/service/GetIdealTypeService.kt`
- `meeple-infra/.../user/command/entity/UserIdealTypeEntity.kt`
- `meeple-infra/.../user/command/mapper/UserIdealTypeMapper.kt`
- `meeple-infra/.../user/command/repository/UserIdealTypeJpaRepository.kt`
- `meeple-infra/.../user/command/adapter/UserIdealTypeCoreAdapter.kt`
- `meeple-infra/.../user/query/GetIdealTypeDaoImpl.kt`
- `meeple-api/.../api/user/IdealTypeController.kt`
- `meeple-api/.../api/user/request/SaveIdealTypeRequest.kt`
- `meeple-api/.../api/user/response/IdealTypeResponse.kt`
- `docs/migration/user_ideal_types.sql`
- 테스트: `meeple-api/src/test/.../domain/user/UserIdealTypeTest.kt`(도메인 유닛), `meeple-api/src/test/.../api/user/IdealTypeE2ETest.kt`

**수정 파일**
- `meeple-core/.../user/UserErrorCode.kt` — 범위 검증 에러 코드 추가

패키지 접두: `com.org.meeple`. 경로의 `.../`는 각 모듈 `src/main/kotlin/com/org/meeple`.
...
**Files:**
- Create: `meeple-common/src/main/kotlin/com/org/meeple/common/user/DistancePreference.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/user/command/domain/UserIdealType.kt`
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/user/UserErrorCode.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/domain/user/UserIdealTypeTest.kt`
...
`meeple-common/src/main/kotlin/com/org/meeple/common/user/DistancePreference.kt`:
...
`meeple-core/.../user/UserErrorCode.kt`의 `// 프로필(user_details)` 블록 마지막(`EMAIL_REQUIRED` 아래) 줄에 추가:
...
`meeple-api/src/test/kotlin/com/org/meeple/domain/user/UserIdealTypeTest.kt`:
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.domain.user.UserIdealTypeTest"`
Expected: FAIL — `UserIdealType` 미정의로 컴파일 에러.

- [ ] **Step 5: 도메인 모델 구현**

`meeple-core/src/main/kotlin/com/org/meeple/core/user/command/domain/UserIdealType.kt`:
...
```bash
git add meeple-common/src/main/kotlin/com/org/meeple/common/user/DistancePreference.kt \
        meeple-core/src/main/kotlin/com/org/meeple/core/user/command/domain/UserIdealType.kt \
        meeple-core/src/main/kotlin/com/org/meeple/core/user/UserErrorCode.kt \
        meeple-api/src/test/kotlin/com/org/meeple/domain/user/UserIdealTypeTest.kt
...
**Files:**
- Create: `meeple-core/.../user/command/application/port/in/command/SaveIdealTypeCommand.kt`
- Create: `meeple-core/.../user/command/application/port/in/SaveIdealTypeUseCase.kt`
- Create: `meeple-core/.../user/command/application/port/out/GetIdealTypePort.kt`
- Create: `meeple-core/.../user/command/application/port/out/SaveIdealTypePort.kt`
- Create: `meeple-core/.../user/command/application/SaveIdealTypeService.kt`
- Create: `meeple-core/.../user/query/dto/IdealTypeView.kt`
- Create: `meeple-core/.../user/query/dao/GetIdealTypeDao.kt`
- Create: `meeple-core/.../user/query/service/port/in/GetIdealTypeUseCase.kt`
- Create: `meeple-core/.../user/query/service/GetIdealTypeService.kt`
...
```bash
git add meeple-core/src/main/kotlin/com/org/meeple/core/user/command/application \
        meeple-core/src/main/kotlin/com/org/meeple/core/user/query
...
**Files:**
- Create: `meeple-infra/.../user/command/entity/UserIdealTypeEntity.kt`
- Create: `meeple-infra/.../user/command/mapper/UserIdealTypeMapper.kt`
- Create: `meeple-infra/.../user/command/repository/UserIdealTypeJpaRepository.kt`
- Create: `meeple-infra/.../user/command/adapter/UserIdealTypeCoreAdapter.kt`
- Create: `meeple-infra/.../user/query/GetIdealTypeDaoImpl.kt`
 ...
 * 도메인 포트는 [com.org.meeple.infra.user.command.adapter.UserIdealTypeCoreAdapter]가 구현하고,
 * 조회 read model 투영은 [com.org.meeple.infra.user.query.GetIdealTypeDaoImpl]가 이 리포지토리를 재사용한다.
 */
...
```bash
git add meeple-infra/src/main/kotlin/com/org/meeple/infra/user/command/entity/UserIdealTypeEntity.kt \
        meeple-infra/src/main/kotlin/com/org/meeple/infra/user/command/mapper/UserIdealTypeMapper.kt \
        meeple-infra/src/main/kotlin/com/org/meeple/infra/user/command/repository/UserIdealTypeJpaRepository.kt \
        meeple-infra/src/main/kotlin/com/org/meeple/infra/user/command/adapter/UserIdealTypeCoreAdapter.kt \
        meeple-infra/src/main/kotlin/com/org/meeple/infra/user/query/GetIdealTypeDaoImpl.kt
...
**Files:**
- Create: `meeple-api/.../api/user/request/SaveIdealTypeRequest.kt`
- Create: `meeple-api/.../api/user/response/IdealTypeResponse.kt`
- Create: `meeple-api/.../api/user/IdealTypeController.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/api/user/IdealTypeE2ETest.kt`
 ...
 * 값 규칙(min ≤ max·경계·짝 존재)은 도메인 [com.org.meeple.core.user.command.domain.UserIdealType]가 검증한다.
 */
...
`meeple-api/src/test/kotlin/com/org/meeple/api/user/IdealTypeE2ETest.kt`:
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.api.user.IdealTypeE2ETest"`
...
```bash
git add meeple-api/src/main/kotlin/com/org/meeple/api/user/IdealTypeController.kt \
        meeple-api/src/main/kotlin/com/org/meeple/api/user/request/SaveIdealTypeRequest.kt \
        meeple-api/src/main/kotlin/com/org/meeple/api/user/response/IdealTypeResponse.kt \
        meeple-api/src/test/kotlin/com/org/meeple/api/user/IdealTypeE2ETest.kt
