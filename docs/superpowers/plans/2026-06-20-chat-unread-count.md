...
- **모듈 경계**: 실시간 읽음 command는 `oneulsogae-chatting`(core 비의존), 영속성 어댑터는 `oneulsogae-infra`, 조회 read model은 `oneulsogae-core`, HTTP/응답 DTO·E2E는 `oneulsogae-api`.
...
**oneulsogae-chatting (실시간 읽음 command):**
...
- Create: `oneulsogae-chatting/src/main/kotlin/com/org/oneulsogae/chatting/chat/application/port/out/AdvanceReadPointerPort.kt`
- Modify: `oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/chat/command/repository/ChatRoomMemberJpaRepository.kt`
- Modify: `oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/chat/command/adapter/ChatRoomMemberAdapter.kt`
- Create: `oneulsogae-chatting/src/main/kotlin/com/org/oneulsogae/chatting/chat/application/port/in/command/MarkMessagesAsReadCommand.kt`
- Create: `oneulsogae-chatting/src/main/kotlin/com/org/oneulsogae/chatting/chat/application/port/in/result/MarkMessagesAsReadResult.kt`
- Create: `oneulsogae-chatting/src/main/kotlin/com/org/oneulsogae/chatting/chat/application/port/in/MarkMessagesAsReadUseCase.kt`
- Create: `oneulsogae-chatting/src/main/kotlin/com/org/oneulsogae/chatting/chat/application/MarkMessagesAsReadService.kt`
- Test: `oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/chat/MarkMessagesAsReadServiceIntegrationTest.kt`
...
```kotlin
import com.org.oneulsogae.chatting.chat.application.port.out.AdvanceReadPointerPort
import java.time.LocalDateTime
```
...
```kotlin
package com.org.oneulsogae.chatting.chat.application.port.`in`.result
...
```kotlin
package com.org.oneulsogae.chatting.chat.application

import com.org.oneulsogae.chatting.chat.application.port.`in`.MarkMessagesAsReadUseCase
import com.org.oneulsogae.chatting.chat.application.port.`in`.command.MarkMessagesAsReadCommand
import com.org.oneulsogae.chatting.chat.application.port.`in`.result.MarkMessagesAsReadResult
import com.org.oneulsogae.chatting.chat.application.port.out.AdvanceReadPointerPort
import com.org.oneulsogae.chatting.chat.application.port.out.GetChatRoomMemberPort
import com.org.oneulsogae.chatting.chat.application.port.out.TimeGenerator
...
Run: `./gradlew :oneulsogae-api:test --tests "com.org.oneulsogae.api.chat.MarkMessagesAsReadServiceIntegrationTest"`
...
```bash
git add oneulsogae-infra oneulsogae-core oneulsogae-chatting oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/chat/MarkMessagesAsReadServiceIntegrationTest.kt
...
**Files:**
- Modify: `oneulsogae-chatting/src/main/kotlin/com/org/oneulsogae/chatting/chat/application/SendChatMessageService.kt`
- Test: `oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/chat/SendChatMessageSenderPointerIntegrationTest.kt`
...
Run: `./gradlew :oneulsogae-api:test --tests "com.org.oneulsogae.api.chat.SendChatMessageSenderPointerIntegrationTest"`
...
```bash
git add oneulsogae-chatting oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/chat/SendChatMessageSenderPointerIntegrationTest.kt
git commit -m "$(cat <<'EOF'
...
**Files:**
- Create: `oneulsogae-chatting/src/main/kotlin/com/org/oneulsogae/chatting/chat/adapter/web/request/ChatReadReportRequest.kt`
- Create: `oneulsogae-chatting/src/main/kotlin/com/org/oneulsogae/chatting/chat/adapter/web/response/MessageReadDto.kt`
- Modify: `oneulsogae-chatting/src/main/kotlin/com/org/oneulsogae/chatting/chat/adapter/web/ChatMessageController.kt`
- Create: `oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/chat/StompTestClient.kt`
- Test: `oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/chat/MarkMessagesReadStompE2ETest.kt`
...
```kotlin
package com.org.oneulsogae.chatting.chat.adapter.web.request
...
Run: `./gradlew :oneulsogae-api:test --tests "com.org.oneulsogae.api.chat.MarkMessagesReadStompE2ETest"`
...
```bash
git add oneulsogae-chatting oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/chat/StompTestClient.kt oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/chat/MarkMessagesReadStompE2ETest.kt
git commit -m "$(cat <<'EOF'
...
**Files:**
- Modify: `oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/chat/query/dto/ChatParticipant.kt`
- Modify: `oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/chat/query/GetChatParticipantDaoImpl.kt`
- Modify: `oneulsogae-api/src/main/kotlin/com/org/oneulsogae/api/chat/response/ChatRoomDetailResponse.kt`
- Test: `oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/chat/GetChatRoomDetailE2ETest.kt`
...
`GetChatRoomDetailE2ETest.kt`의 `describe("GET /chat/v1/rooms/{chatRoomId}")` 블록 안, 마지막 `context(...)`들 사이 적당한 위치에 새 context를 추가한다. import에 다음이 없으면 추가: `import org.hamcrest.Matchers.nullValue` (이미 존재), `import com.org.oneulsogae.common.chat.ChatRoomMemberStatus`.
...
Run: `./gradlew :oneulsogae-api:test --tests "com.org.oneulsogae.api.chat.GetChatRoomDetailE2ETest"`
...
Run: `./gradlew :oneulsogae-api:test --tests "com.org.oneulsogae.api.chat.*"`
