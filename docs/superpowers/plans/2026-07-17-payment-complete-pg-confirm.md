...
**신규**
- `meeple-core/.../payments/command/application/port/out/PaymentGatewayPort.kt` — PG 승인 out-port.
- `meeple-infra/.../payments/command/adapter/StubPaymentGatewayAdapter.kt` — stub 구현(비-prod, 헤더 제어).
- `meeple-core/.../gathering/command/application/port/in/ReleaseGatheringSeatUseCase.kt` — 좌석 복원 in-port.
- `meeple-core/.../gathering/command/application/ReleaseGatheringSeatService.kt` — 좌석 복원 서비스.

**변경**
- `meeple-core/.../gathering/command/domain/JoiningSchedule.kt` — `restore(gender, earlyBirdApplied)` 추가.
- `meeple-core/.../gathering/command/domain/GatheringMember.kt` — `cancel()` 추가.
- `meeple-core/.../payments/PaymentsErrorCode.kt` — `PAYMENT_CONFIRM_FAILED` 추가.
- `meeple-core/.../payments/command/domain/Payment.kt` — `paymentKey` 추가.
- `meeple-core/.../payments/command/application/port/in/command/CompletePaymentCommand.kt` — `paymentKey` 추가.
- `meeple-api/.../payments/request/CompletePaymentRequest.kt` — `paymentKey` 추가.
- `meeple-infra/.../payments/command/entity/PaymentEntity.kt` — `payment_key` 컬럼.
- `meeple-infra/.../payments/command/adapter/PaymentAdapter.kt` — `paymentKey` 매핑.
- `docs/migration/payments.sql` — `payment_key` 컬럼.
- `meeple-core/.../payments/command/application/CompletePaymentService.kt` — confirm 오케스트레이션.
- `meeple-api/src/test/kotlin/com/org/meeple/common/integration/RestAssuredDsl.kt` — 커스텀 헤더 메서드.
- `meeple-api/src/test/kotlin/com/org/meeple/api/payments/PaymentsCompleteE2ETest.kt` — paymentKey·confirm 케이스.
- `meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/JoiningScheduleTest.kt` — `restore` 유닛.
- (신규 test) `meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/GatheringMemberTest.kt` — `cancel` 유닛.
...
**Files:**
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/payments/command/application/port/out/PaymentGatewayPort.kt`
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/payments/command/adapter/StubPaymentGatewayAdapter.kt`
- Modify: `meeple-api/src/test/kotlin/com/org/meeple/common/integration/RestAssuredDsl.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/infra/payments/StubPaymentGatewayAdapterTest.kt` (신규, 순수 로직 유닛)
...
Create `meeple-api/src/test/kotlin/com/org/meeple/infra/payments/StubPaymentGatewayAdapterTest.kt`:
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.infra.payments.StubPaymentGatewayAdapterTest"`
...
```bash
git add meeple-core/src/main/kotlin/com/org/meeple/core/payments/command/application/port/out/PaymentGatewayPort.kt \
        meeple-infra/src/main/kotlin/com/org/meeple/infra/payments/command/adapter/StubPaymentGatewayAdapter.kt \
        meeple-api/src/test/kotlin/com/org/meeple/infra/payments/StubPaymentGatewayAdapterTest.kt \
        meeple-api/src/test/kotlin/com/org/meeple/common/integration/RestAssuredDsl.kt
...
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/domain/GatheringMember.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/application/port/in/ReleaseGatheringSeatUseCase.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/application/ReleaseGatheringSeatService.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/JoiningScheduleTest.kt` (restore 추가)
- Test: `meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/GatheringMemberTest.kt` (신규)
...
Create `meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/GatheringMemberTest.kt`:
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.domain.gathering.GatheringMemberTest"`
...
Run: `./gradlew :meeple-core:compileKotlin :meeple-api:test --tests "com.org.meeple.domain.gathering.*"`
...
git add meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/domain/JoiningSchedule.kt \
        meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/domain/GatheringMember.kt \
        meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/application/port/in/ReleaseGatheringSeatUseCase.kt \
        meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/application/ReleaseGatheringSeatService.kt \
        meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/JoiningScheduleTest.kt \
        meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/GatheringMemberTest.kt
...
- Modify: `meeple-core/.../payments/command/domain/Payment.kt`
- Modify: `meeple-infra/.../payments/command/adapter/PaymentAdapter.kt`
- Modify: `meeple-core/.../payments/command/application/port/in/command/CompletePaymentCommand.kt`
- Modify: `meeple-api/.../payments/request/CompletePaymentRequest.kt`
...
git add docs/migration/payments.sql \
        meeple-infra/src/main/kotlin/com/org/meeple/infra/payments/command/entity/PaymentEntity.kt \
        meeple-core/src/main/kotlin/com/org/meeple/core/payments/command/domain/Payment.kt \
        meeple-infra/src/main/kotlin/com/org/meeple/infra/payments/command/adapter/PaymentAdapter.kt \
...
**Files:**
- Modify: `meeple-core/.../payments/PaymentsErrorCode.kt`
- Modify: `meeple-core/.../payments/command/application/CompletePaymentService.kt`
- Modify: `meeple-api/.../payments/PaymentsController.kt` (스웨거 설명에 PAYMENTS-004 추가 — 선택)
- Test: `meeple-api/src/test/kotlin/com/org/meeple/api/payments/PaymentsCompleteE2ETest.kt`
