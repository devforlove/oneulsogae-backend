...
**Files:**
- Create: `oneulsogae-scheduler/src/main/kotlin/com/org/oneulsogae/scheduler/match/command/application/port/out/RegionShuffler.kt`
- Create: `oneulsogae-scheduler/src/main/kotlin/com/org/oneulsogae/scheduler/match/command/application/port/out/RandomRegionShuffler.kt`
- Create (test): `oneulsogae-api/src/test/kotlin/com/org/oneulsogae/scheduler/match/RandomRegionShufflerTest.kt`
...
`oneulsogae-api/src/test/kotlin/com/org/oneulsogae/scheduler/match/RandomRegionShufflerTest.kt`:
```kotlin
package com.org.oneulsogae.scheduler.match

import com.org.oneulsogae.scheduler.match.command.application.port.out.RandomRegionShuffler
...
Run: `./gradlew :oneulsogae-api:test --tests "com.org.oneulsogae.scheduler.match.RandomRegionShufflerTest"`
...
```bash
git add oneulsogae-scheduler/src/main/kotlin/com/org/oneulsogae/scheduler/match/command/application/port/out/RegionShuffler.kt \
        oneulsogae-scheduler/src/main/kotlin/com/org/oneulsogae/scheduler/match/command/application/port/out/RandomRegionShuffler.kt \
        oneulsogae-api/src/test/kotlin/com/org/oneulsogae/scheduler/match/RandomRegionShufflerTest.kt
...
**Files:**
- Modify: `oneulsogae-scheduler/src/main/kotlin/com/org/oneulsogae/scheduler/match/command/application/SoloMatchBatchService.kt`
...
import 추가: `import com.org.oneulsogae.scheduler.match.command.application.port.out.RegionShuffler`
...
```bash
git add oneulsogae-scheduler/src/main/kotlin/com/org/oneulsogae/scheduler/match/command/application/SoloMatchBatchService.kt \
        oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/scheduler/RunSoloMatchBatchIntegrationTest.kt
