...
**Files:**
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/common/time/BirthdayAge.kt`
...
```bash
git add meeple-core/src/main/kotlin/com/org/meeple/core/common/time/BirthdayAge.kt
...
core 모듈의 모든 `age` 참조를 birthday로 바꾼다. core는 common에만 의존하므로 이 Task 완료 시 `:meeple-core:build`가 통과해야 한다(테스트 픽스처 포함).

**Files:**
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/user/UserErrorCode.kt`
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/user/command/domain/UserDetail.kt`
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/user/command/application/port/in/command/UpdateUserDetailCommand.kt`
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/user/command/application/UpdateUserDetailService.kt`
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/common/event/MatchProfileSnapshot.kt`
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/match/command/domain/MatchUser.kt`
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/user/query/dto/UserDetailView.kt`
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/match/query/dto/InvitableUser.kt`
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/match/query/dto/ReceivedInvitation.kt`
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/match/query/dto/SentInvitation.kt`
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/match/query/dto/MatchWithPartner.kt`
- Modify: `meeple-core/src/testFixtures/kotlin/com/org/meeple/core/fixture/UserDetailFixture.kt`
...
**Files:**
- Modify: `meeple-scheduler/src/main/kotlin/com/org/meeple/scheduler/match/query/dto/MatchBatchTarget.kt`
...
**Files:**
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/user/command/entity/UserDetailEntity.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/match/command/entity/MatchUserEntity.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/user/command/mapper/UserDetailMapper.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/match/command/mapper/MatchUserMapper.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/match/query/SearchInvitableUsersDaoImpl.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/match/query/GetReceivedInvitationsDaoImpl.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/match/query/GetSentInvitationDaoImpl.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/match/query/GetMatchWithPartnerDaoImpl.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/match/query/GetMatchBatchTargetDaoImpl.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/user/query/GetUserDetailDaoImpl.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/user/query/GetUserWithDetailDaoImpl.kt`
- Modify: `meeple-infra/src/testFixtures/kotlin/com/org/meeple/infra/fixture/UserDetailEntityFixture.kt`
- Modify: `meeple-infra/src/testFixtures/kotlin/com/org/meeple/infra/fixture/MatchUserEntityFixture.kt`
...
Run: `./gradlew :meeple-infra:build`
...
**Files:**
- Modify: `meeple-api/src/main/kotlin/com/org/meeple/api/user/request/UpdateUserDetailRequest.kt`
- Modify: `meeple-api/src/main/kotlin/com/org/meeple/api/user/response/UserProfileResponse.kt`
- Modify: `meeple-api/src/main/kotlin/com/org/meeple/api/match/response/InvitableUserResponse.kt`
- Modify: `meeple-api/src/main/kotlin/com/org/meeple/api/match/response/ReceivedInvitationResponse.kt`
- Modify: `meeple-api/src/main/kotlin/com/org/meeple/api/match/response/SentInvitationResponse.kt`
- Modify: `meeple-api/src/main/kotlin/com/org/meeple/api/match/response/MatchResponse.kt`
- Modify: `meeple-api/src/main/kotlin/com/org/meeple/api/user/UserProfileController.kt`
- Modify: `meeple-api/src/main/kotlin/com/org/meeple/api/match/MatchController.kt`
...
`InvitableUserResponse.kt`: import `com.org.meeple.core.common.time.ageAt`, `java.time.LocalDate` 추가.
...
`ReceivedInvitationResponse.kt`: import `com.org.meeple.core.common.time.ageAt`, `java.time.LocalDate` 추가.
...
`SentInvitationResponse.kt`: import `com.org.meeple.core.common.time.ageAt`, `java.time.LocalDate` 추가.
...
`MatchResponse.kt`: import `com.org.meeple.core.common.time.ageAt`, `java.time.LocalDate` 추가.
...
`UserProfileController.kt`: import `com.org.meeple.core.common.time.TimeGenerator` 추가. 생성자에 `private val timeGenerator: TimeGenerator` 주입. 두 호출 변경:
```kotlin
...
`MatchController.kt`: import `com.org.meeple.core.common.time.TimeGenerator` 추가. 생성자에 `private val timeGenerator: TimeGenerator` 주입. `myMatches` 호출 변경:
```kotlin
...
`TeamController.kt`: import `com.org.meeple.core.common.time.TimeGenerator` 추가. 생성자에 `private val timeGenerator: TimeGenerator` 주입. 세 호출 변경:
```kotlin
...
도메인 단위 테스트는 `meeple-api/src/test/kotlin/com/org/meeple/domain/`에 있다(Kotest). 고정 `today`로 결정적으로 검증한다.

**Files:**
- Modify: `meeple-api/src/test/kotlin/com/org/meeple/domain/user/UserDetailTest.kt`
- Modify: `meeple-api/src/test/kotlin/com/org/meeple/domain/match/MatchUserTest.kt`
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.domain.*"`
Expected: PASS (새 검증·파생 케이스 포함)

- [ ] **Step 4: 커밋**

```bash
git add meeple-api/src/test/kotlin/com/org/meeple/domain
...
**Files:**
- Modify: `meeple-api/src/test/kotlin/com/org/meeple/api/user/RequestCompanyEmailVerificationE2ETest.kt`
- Modify: `meeple-api/src/test/kotlin/com/org/meeple/api/match/SearchInvitableUsersE2ETest.kt`
- Modify: `meeple-api/src/test/kotlin/com/org/meeple/api/match/GetReceivedInvitationsE2ETest.kt`
- Modify: `meeple-api/src/test/kotlin/com/org/meeple/api/match/GetSentInvitationE2ETest.kt`
- Modify: `meeple-api/src/test/kotlin/com/org/meeple/api/match/GetMatchesE2ETest.kt`
- Modify: `meeple-api/src/test/kotlin/com/org/meeple/api/match/MatchUserSyncE2ETest.kt`
...
> 단언이 RestAssured Hamcrest `equalTo(Int)`를 쓰면 `equalTo(EXPECTED_AGE)`로 바꾼다. import에 `java.time.LocalDate`, `com.org.meeple.core.common.time.ageAt` 추가.
