...
**Architecture:** 엔티티에 nullable 컬럼 2개를 추가하고(운영은 마이그레이션 SQL, 테스트는 ddl-auto create-drop), core 제출 vertical(도메인·command·서비스·컨트롤러)에 companyName을, oneulsogae-admin 반려 흐름에 rejectionReason을 더한다. 어드민 상세 read model에 두 값을 노출한다.
...
- Modify: `oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/user/command/domain/CompanyImageVerification.kt`
- Modify: `oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/user/command/entity/CompanyImageVerificationEntity.kt`
- Modify: `oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/user/command/mapper/CompanyImageVerificationMapper.kt`
- Modify: `oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/user/command/application/port/in/command/SubmitCompanyImageVerificationCommand.kt`
- Modify: `oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/user/command/application/SubmitCompanyImageVerificationService.kt`
- Modify: `oneulsogae-api/src/main/kotlin/com/org/oneulsogae/api/user/UserCompanyImageVerificationController.kt`
- Modify: `oneulsogae-infra/src/testFixtures/kotlin/com/org/oneulsogae/infra/fixture/CompanyImageVerificationEntityFixture.kt`
- Modify: `oneulsogae-api/src/test/kotlin/com/org/oneulsogae/domain/user/CompanyImageVerificationTest.kt`
- Modify: `oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/user/SubmitCompanyImageVerificationE2ETest.kt`
	...
	describe("create") {
		it("제출은 심사 대기(PENDING)로 시작하고 희망 회사명을 담는다") {
			val verification: CompanyImageVerification =
				CompanyImageVerification.create(userId = 1L, imageKey = "k/1/a.jpg", companyName = "오늘의 소개")
		...
		it("imageKey가 비면 생성할 수 없다") {
			shouldThrow<IllegalArgumentException> {
				CompanyImageVerification.create(userId = 1L, imageKey = " ", companyName = "오늘의 소개")
			}
		}
...
Run: `./gradlew :oneulsogae-api:test --tests "com.org.oneulsogae.domain.user.CompanyImageVerificationTest" -q`
...
`SubmitCompanyImageVerificationE2ETest.kt`에서 **기존 모든** `RestAssured.given()...` 요청의 `.multiPart("image", ...)` 뒤에 `.multiPart("companyName", "오늘의 소개")`를 추가한다. 정상 업로드 케이스에는 저장 검증 `saved.companyName shouldBe "오늘의 소개"`을 추가한다(`saved`는 이미 로드하는 `latestVerificationOf(userId)!!`). 그리고 아래 검증 케이스를 `describe` 블록 안에 추가한다:
...
Run: `./gradlew :oneulsogae-api:test --tests "com.org.oneulsogae.domain.user.CompanyImageVerificationTest" --tests "com.org.oneulsogae.api.user.SubmitCompanyImageVerificationE2ETest" -q`
...
git add oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/user/UserErrorCode.kt \
        oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/user/command/domain/CompanyImageVerification.kt \
        oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/user/command/entity/CompanyImageVerificationEntity.kt \
        oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/user/command/mapper/CompanyImageVerificationMapper.kt \
        "oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/user/command/application/port/in/command/SubmitCompanyImageVerificationCommand.kt" \
        oneulsogae-core/src/main/kotlin/com/org/oneulsogae/core/user/command/application/SubmitCompanyImageVerificationService.kt \
        oneulsogae-api/src/main/kotlin/com/org/oneulsogae/api/user/UserCompanyImageVerificationController.kt \
        oneulsogae-infra/src/testFixtures/kotlin/com/org/oneulsogae/infra/fixture/CompanyImageVerificationEntityFixture.kt \
        oneulsogae-api/src/test/kotlin/com/org/oneulsogae/domain/user/CompanyImageVerificationTest.kt \
        oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/user/SubmitCompanyImageVerificationE2ETest.kt \
        docs/migration/company_image_verifications_company_name_rejection_reason.sql
...
**Files:**
- Modify: `oneulsogae-admin/src/main/kotlin/com/org/oneulsogae/admin/companyverification/command/domain/AdminCompanyImageVerification.kt`
- Modify: `oneulsogae-admin/src/main/kotlin/com/org/oneulsogae/admin/companyverification/command/application/port/in/ReviewCompanyImageVerificationUseCase.kt`
...
- Create: `oneulsogae-api/src/main/kotlin/com/org/oneulsogae/api/admin/request/AdminRejectCompanyVerificationRequest.kt`
...
git add oneulsogae-admin/src/main/kotlin/com/org/oneulsogae/admin/companyverification/command \
        oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/user/command/adapter/CompanyImageVerificationRepositoryAdapter.kt \
        oneulsogae-api/src/main/kotlin/com/org/oneulsogae/api/admin/request/AdminRejectCompanyVerificationRequest.kt \
...
**Files:**
- Modify: `oneulsogae-admin/src/main/kotlin/com/org/oneulsogae/admin/companyverification/query/dto/AdminCompanyVerificationDetailView.kt`
- Modify: `oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/user/query/GetAdminCompanyVerificationDaoImpl.kt`
- Modify: `oneulsogae-api/src/main/kotlin/com/org/oneulsogae/api/admin/response/AdminCompanyVerificationDetailResponse.kt`
...
git add oneulsogae-admin/src/main/kotlin/com/org/oneulsogae/admin/companyverification/query/dto/AdminCompanyVerificationDetailView.kt \
        oneulsogae-infra/src/main/kotlin/com/org/oneulsogae/infra/user/query/GetAdminCompanyVerificationDaoImpl.kt \
        oneulsogae-api/src/main/kotlin/com/org/oneulsogae/api/admin/response/AdminCompanyVerificationDetailResponse.kt
...
- Modify: `oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/admin/AdminCompanyVerificationDetailE2ETest.kt`
...
(필요 import: `com.org.oneulsogae.common.user.CompanyImageVerificationStatus`, `com.org.oneulsogae.infra.fixture.UserDetailEntityFixture` 등 파일에 없으면 추가. `AdminCompanyVerificationReviewE2ETest`에는 `CompanyImageVerificationEntity` import가 이미 있음.)

- [ ] **Step 3: 어드민 E2E 실행**

Run: `./gradlew :oneulsogae-api:test --tests "com.org.oneulsogae.api.admin.AdminCompanyVerificationReviewE2ETest" --tests "com.org.oneulsogae.api.admin.AdminCompanyVerificationDetailE2ETest" -q`
...
git add oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/admin/AdminCompanyVerificationReviewE2ETest.kt \
        oneulsogae-api/src/test/kotlin/com/org/oneulsogae/api/admin/AdminCompanyVerificationDetailE2ETest.kt
