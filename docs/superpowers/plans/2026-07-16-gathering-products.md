...
- 유닛 테스트 실행: `./gradlew :meeple-api:test --tests "<FQCN 또는 패턴>"`. E2E도 동일 모듈.
...
**Files:**
- Create: `meeple-common/src/main/kotlin/com/org/meeple/common/gathering/GatheringProductType.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/domain/GatheringProduct.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/domain/GatheringProducts.kt`
- Test: `meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/GatheringProductsTest.kt`

**Interfaces:**
- Consumes: `GatheringFee(male: Int, female: Int)` (admin 도메인, 기존), `Gender` (`com.org.meeple.common.user.Gender`, MALE/FEMALE)
...
`meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/GatheringProductsTest.kt`:
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.domain.gathering.GatheringProductsTest"`
Expected: 컴파일 실패 (`GatheringProduct`/`GatheringProducts`/`GatheringProductType` unresolved)

- [ ] **Step 3: 구현**

`meeple-common/src/main/kotlin/com/org/meeple/common/gathering/GatheringProductType.kt`:

```kotlin
package com.org.meeple.common.gathering

/** 모임 일정 상품([com.org.meeple.infra.gathering.command.entity.GatheringProductEntity])의 가격 타입. */
...
`meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/domain/GatheringProduct.kt`:
...
`meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/domain/GatheringProducts.kt`:
...
```bash
git add meeple-common/src/main/kotlin/com/org/meeple/common/gathering/GatheringProductType.kt \
  meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/domain/GatheringProduct.kt \
  meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/domain/GatheringProducts.kt \
  meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/GatheringProductsTest.kt
...
**Files:**
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/entity/GatheringProductEntity.kt`
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/repository/GatheringProductJpaRepository.kt`
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/mapper/GatheringProductMapper.kt`
- Create: `meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/application/port/out/SaveGatheringProductPort.kt`
- Create: `meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/adapter/GatheringProductAdapter.kt`
- Create: `meeple-infra/src/testFixtures/kotlin/com/org/meeple/infra/fixture/GatheringProductEntityFixture.kt`
...
`meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/entity/GatheringProductEntity.kt`:
...
`meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/repository/GatheringProductJpaRepository.kt`:
...
`meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/mapper/GatheringProductMapper.kt`:
...
`meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/application/port/out/SaveGatheringProductPort.kt`:
...
`meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/adapter/GatheringProductAdapter.kt`:
...
`meeple-infra/src/testFixtures/kotlin/com/org/meeple/infra/fixture/GatheringProductEntityFixture.kt`:
...
Run: `./gradlew :meeple-infra:compileKotlin :meeple-infra:compileTestFixturesKotlin :meeple-admin:compileKotlin`
Expected: BUILD SUCCESSFUL

- [ ] **Step 5: 커밋**

```bash
git add meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/entity/GatheringProductEntity.kt \
  meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/repository/GatheringProductJpaRepository.kt \
  meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/mapper/GatheringProductMapper.kt \
  meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/adapter/GatheringProductAdapter.kt \
  meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/application/port/out/SaveGatheringProductPort.kt \
...
**Files:**
- Modify: `meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/domain/GatheringSchedule.kt`
- Modify: `meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/application/CreateGatheringScheduleService.kt`
- Test(Modify): `meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/GatheringScheduleTest.kt`
- Test(Modify): `meeple-api/src/test/kotlin/com/org/meeple/api/admin/AdminGatheringScheduleE2ETest.kt`
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.domain.gathering.GatheringScheduleTest"`
...
import 추가: `import com.org.meeple.admin.gathering.command.application.port.out.SaveGatheringProductPort`. 클래스 KDoc에 상품 저장 문장 추가.

- [ ] **Step 4: 유닛 테스트 통과 확인**

Run: `./gradlew :meeple-api:test --tests "com.org.meeple.domain.gathering.GatheringScheduleTest" --tests "com.org.meeple.domain.gathering.GatheringProductsTest"`
Expected: PASS
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.api.admin.AdminGatheringScheduleE2ETest"`
Expected: PASS

- [ ] **Step 7: 커밋**

```bash
git add meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/domain/GatheringSchedule.kt \
  meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/application/CreateGatheringScheduleService.kt \
  meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/GatheringScheduleTest.kt \
  meeple-api/src/test/kotlin/com/org/meeple/api/admin/AdminGatheringScheduleE2ETest.kt
...
**Files:**
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/domain/JoiningSchedule.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/adapter/GatheringScheduleAdapter.kt`
- Test(Modify): `meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/JoiningScheduleTest.kt`
- Test(Modify): `meeple-api/src/test/kotlin/com/org/meeple/api/payments/PaymentsCompleteE2ETest.kt`
- Test(Modify): `meeple-api/src/test/kotlin/com/org/meeple/admin/gathering/AdminGatheringMemberE2ETest.kt`
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.api.payments.PaymentsCompleteE2ETest" --tests "com.org.meeple.admin.gathering.AdminGatheringMemberE2ETest"`
Expected: PASS

- [ ] **Step 7: 커밋**

```bash
git add meeple-core/src/main/kotlin/com/org/meeple/core/gathering/command/domain/JoiningSchedule.kt \
  meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/adapter/GatheringScheduleAdapter.kt \
  meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/JoiningScheduleTest.kt \
  meeple-api/src/test/kotlin/com/org/meeple/api/payments/PaymentsCompleteE2ETest.kt \
  meeple-api/src/test/kotlin/com/org/meeple/admin/gathering/AdminGatheringMemberE2ETest.kt
...
**Files:**
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/gathering/query/dto/GatheringProductView.kt`
...
Run: `./gradlew :meeple-api:compileKotlin :meeple-core:compileKotlin :meeple-infra:compileKotlin`
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.api.offline.OfflineGatheringDetailE2ETest" --tests "com.org.meeple.api.payments.PaymentsCheckoutE2ETest"`
Expected: PASS
...
**Files:**
- Modify: `meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/query/dto/AdminGatheringScheduleView.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/query/GetAdminGatheringDaoImpl.kt`
- Modify: `meeple-api/src/main/kotlin/com/org/meeple/api/admin/response/AdminGatheringDetailResponse.kt`
- Test(Modify): `meeple-api/src/test/kotlin/com/org/meeple/api/admin/AdminGatheringQueryE2ETest.kt`
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.api.admin.AdminGatheringQueryE2ETest"`
Expected: PASS

- [ ] **Step 5: 커밋**

```bash
git add meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/query/dto/AdminGatheringScheduleView.kt \
  meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/query/GetAdminGatheringDaoImpl.kt \
  meeple-api/src/main/kotlin/com/org/meeple/api/admin/response/AdminGatheringDetailResponse.kt \
  meeple-api/src/test/kotlin/com/org/meeple/api/admin/AdminGatheringQueryE2ETest.kt
...
**Files:**
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/entity/GatheringScheduleEntity.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/gathering/command/mapper/GatheringScheduleMapper.kt`
- Modify: `meeple-admin/src/main/kotlin/com/org/meeple/admin/gathering/command/domain/GatheringSchedule.kt`
- Modify: `meeple-infra/src/testFixtures/kotlin/com/org/meeple/infra/fixture/GatheringScheduleEntityFixture.kt`
- Test(Modify): `meeple-api/src/test/kotlin/com/org/meeple/domain/gathering/GatheringScheduleTest.kt`
- Test(Modify): `meeple-api/src/test/kotlin/com/org/meeple/api/admin/AdminGatheringScheduleE2ETest.kt`
