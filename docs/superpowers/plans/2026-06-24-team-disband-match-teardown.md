...
- 도메인 모델은 Kotest 유닛, `meeple-api` 경계는 E2E(`AbstractIntegrationSupport` + `IntegrationUtil` + 엔티티 픽스처).
- 새 알림 문구(확정): title `"상대 팀 해체"`, description `"상대 팀이 해체되었어요."`, `link = ""`(없음), `fromTeamId = 해체된 팀 id`.
- 도메인 유닛 테스트는 `meeple-api/src/test/kotlin/com/org/meeple/domain/...` 아래에 둔다(기존 컨벤션).
- 테스트 실행 모듈은 `:meeple-api`.
...
- Test(Create): `meeple-api/src/test/kotlin/com/org/meeple/domain/match/MatchedTeamsTest.kt`
...
```bash
git add meeple-core/src/main/kotlin/com/org/meeple/core/match/command/domain/MatchedTeams.kt \
        meeple-api/src/test/kotlin/com/org/meeple/domain/match/MatchedTeamsTest.kt
...
- Test(Modify): `meeple-api/src/test/kotlin/com/org/meeple/domain/match/TeamMatchTest.kt`
...
**Files:**
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/chat/command/domain/ChatRoomMembers.kt`
- Test(Create): `meeple-api/src/test/kotlin/com/org/meeple/domain/chat/ChatRoomMembersTest.kt`
...
`meeple-api/src/test/kotlin/com/org/meeple/domain/chat/ChatRoomMembersTest.kt`
```kotlin
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.domain.chat.ChatRoomMembersTest"`
...
```bash
git add meeple-core/src/main/kotlin/com/org/meeple/core/chat/command/domain/ChatRoomMembers.kt \
        meeple-api/src/test/kotlin/com/org/meeple/domain/chat/ChatRoomMembersTest.kt
...
**Files:**
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/match/command/application/port/out/GetTeamMatchPort.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/match/command/adapter/TeamMatchAdapter.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/match/command/repository/TeamMatchJpaRepository.kt`
- Modify: `meeple-infra/src/main/kotlin/com/org/meeple/infra/match/command/repository/MatchedTeamJpaRepository.kt`
 ...
 * 구현은 infra의 [com.org.meeple.infra.match.command.adapter.TeamMatchAdapter]가 담당한다.
 */
 ...
 * [com.org.meeple.infra.match.command.adapter.TeamMatchAdapter]가 헤더 저장·조회에 사용한다.
 */
 ...
 * [com.org.meeple.infra.match.command.adapter.TeamMatchAdapter]가 참가 팀 행 저장·조회에 사용한다.
 */
...
```bash
git add meeple-core/src/main/kotlin/com/org/meeple/core/match/command/application/port/out/GetTeamMatchPort.kt \
...
**Files:**
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/chat/command/application/port/in/DeactivateChatRoomMemberUseCase.kt`
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/chat/command/application/DeactivateChatRoomMemberService.kt`
...
```bash
git add meeple-core/src/main/kotlin/com/org/meeple/core/chat/command/application/port/in/DeactivateChatRoomMemberUseCase.kt \
        meeple-core/src/main/kotlin/com/org/meeple/core/chat/command/application/DeactivateChatRoomMemberService.kt
...
**Files:**
- Create: `meeple-core/src/main/kotlin/com/org/meeple/core/match/command/domain/event/OpponentsNotifiedOnDisband.kt`
- Modify: `meeple-common/src/main/kotlin/com/org/meeple/common/alarm/AlarmType.kt`
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/match/command/application/TeamEventHandler.kt`
...
git add meeple-common/src/main/kotlin/com/org/meeple/common/alarm/AlarmType.kt \
        meeple-core/src/main/kotlin/com/org/meeple/core/match/command/domain/event/OpponentsNotifiedOnDisband.kt \
        meeple-core/src/main/kotlin/com/org/meeple/core/match/command/application/TeamEventHandler.kt
...
**Files:**
- Modify: `meeple-core/src/main/kotlin/com/org/meeple/core/match/command/application/DisbandTeamService.kt`
- Test(Create): `meeple-api/src/test/kotlin/com/org/meeple/api/match/DisbandTeamMatchTeardownE2ETest.kt`
...
`meeple-api/src/test/kotlin/com/org/meeple/api/match/DisbandTeamMatchTeardownE2ETest.kt`
```kotlin
...
Run: `./gradlew :meeple-api:test --tests "com.org.meeple.api.match.DisbandTeamMatchTeardownE2ETest"`
...
```bash
git add meeple-core/src/main/kotlin/com/org/meeple/core/match/command/application/DisbandTeamService.kt \
        meeple-api/src/test/kotlin/com/org/meeple/api/match/DisbandTeamMatchTeardownE2ETest.kt
