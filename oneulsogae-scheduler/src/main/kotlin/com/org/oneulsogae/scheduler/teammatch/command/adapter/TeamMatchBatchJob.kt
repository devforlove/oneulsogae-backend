package com.org.oneulsogae.scheduler.teammatch.command.adapter
 ...
 * [RunTeamMatchBatchUseCase]를 실행하고 시작/종료를 로깅한다. "언제 돌릴지"는 이 모듈을 의존하는 실행 앱(oneulsogae-api)이 담당한다.
