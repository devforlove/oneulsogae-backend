package com.org.oneulsogae.scheduler.solomatch.command.application.port.out

import com.org.oneulsogae.common.user.Gender
import java.time.LocalDateTime

/**
 * 배치가 매칭(소개) 이력을 기록하기 위한 아웃포트. (기록 전용 — 조회는 [com.org.oneulsogae.scheduler.solomatch.query.dao.GetMatchRecordDao]가 담당)
