package com.org.oneulsogae.scheduler.teammatch.command.application

import com.org.oneulsogae.common.user.Gender
import com.org.oneulsogae.scheduler.teammatch.command.application.port.`in`.RunTeamMatchBatchUseCase
...
import com.org.oneulsogae.scheduler.teammatch.query.dao.GetMatchableTeamDao
import com.org.oneulsogae.scheduler.teammatch.query.dao.GetTeamMatchRecordDao
...
class TeamMatchBatchService(
	...
	override fun run(): TeamMatchBatchResult {
		...
		noIntroductionAlarmPort.notifyTeamUnmatched(pool.remainingTeamIds(), now)
