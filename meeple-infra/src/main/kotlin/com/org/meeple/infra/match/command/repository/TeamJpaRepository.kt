...
interface TeamJpaRepository : JpaRepository<TeamEntity, Long> {
	...
	/** 주어진 성별([gender])의 결성(ACTIVE) 팀이 하나라도 있는 region_id 목록. ([com.org.meeple.infra.match.command.adapter.TeamPopulatedRegionRegistry]가 성별별 스냅샷으로 캐시해 후보 팀 없는 region 건너뛰기에 쓴다) */
