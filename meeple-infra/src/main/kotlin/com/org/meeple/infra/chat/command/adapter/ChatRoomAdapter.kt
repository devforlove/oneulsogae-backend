...
/**
 * [com.org.meeple.infra.chat.command.entity.ChatRoomEntity]의 out-port 어댑터. (Spring Data 메서드 쿼리)
 ...
 * 목록(read model) 조회는 query 쪽 QueryDSL 구현체([ChatRoomQueryDaoImpl])가 따로 담당한다. (adapter=메서드 쿼리 / dao=QueryDSL 분리)
 */
@Component
