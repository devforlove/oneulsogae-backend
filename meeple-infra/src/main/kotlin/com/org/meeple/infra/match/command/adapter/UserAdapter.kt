...
import com.org.meeple.infra.match.command.repository.MatchCandidateJpaRepository
 ...
 * 소개 배치가 보는 사용자 조회(`ActiveUserQueryDao`/`MatchBatchTargetQueryDao`)는 query 패키지의 `*DaoImpl`이 별도로 구현한다.
 */
@Component
class UserAdapter(
