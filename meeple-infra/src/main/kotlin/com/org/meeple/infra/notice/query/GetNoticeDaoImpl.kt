...
import com.org.meeple.core.notice.query.dao.GetNoticeDao
 ...
 * 저장 out-port([com.org.meeple.core.notice.command.application.port.out.SaveNoticePort])는 [com.org.meeple.infra.notice.command.adapter.NoticeAdapter]가 따로 구현한다.
 */
@Component
