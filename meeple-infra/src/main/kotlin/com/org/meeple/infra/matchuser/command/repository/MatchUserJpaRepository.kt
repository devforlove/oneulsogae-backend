package com.org.meeple.infra.matchuser.command.repository
 ...
 * 온보딩 후보 조회(근접 지역·반대 성별·이력 제외)는 동적 거리 정렬이 필요해 [com.org.meeple.infra.matchuser.command.adapter.MatchUserAdapter]가 QueryDSL로 수행한다.
 */
interface MatchUserJpaRepository : JpaRepository<MatchUserEntity, Long> {
	 ...
	 * ([com.org.meeple.infra.region.PopulatedRegionRegistry]가 성별별 스냅샷으로 캐시해 빈 region 건너뛰기에 쓴다)
