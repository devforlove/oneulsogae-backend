 ...
 * [com.org.meeple.infra.solomatch.command.adapter.MatchAdapter]가 이 리포지토리로 헤더 저장·단건 조회를 구현한다.
 * 재소개 존재 확인·성사 사용자 등 참가자(solo_match_members) 조인이 필요한 조회는 [com.org.meeple.infra.solomatch.query]의 QueryDSL dao가 담당한다.
 */
