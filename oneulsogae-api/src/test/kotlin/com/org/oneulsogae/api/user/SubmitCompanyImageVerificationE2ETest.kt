 ...
 * (실제 S3 업로드는 [com.org.oneulsogae.common.config.TestFileStorageConfig]의 페이크로 대체 — 어댑터는 S3FileStorageAdapterIntegrationTest에서 검증)
 */
		...
		context("유효한 서류 이미지를 업로드하면") {
			it("company_image_verifications에 오브젝트 키·PENDING으로 저장하고 200을 반환한다") {
				...
				RestAssured.given()
					...
					.multiPart("companyName", "오늘의 소개", "text/plain;charset=UTF-8")
				...
				saved.companyName shouldBe "오늘의 소개"
			}
		}
