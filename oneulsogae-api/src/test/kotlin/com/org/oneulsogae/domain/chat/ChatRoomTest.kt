...
import com.org.oneulsogae.core.fixture.ChatRoomFixture
 ...
 * 참가자(누가 방에 있는지)는 방이 아니라 [com.org.oneulsogae.core.chat.command.domain.ChatRoomMembers]가 보관하므로, 참가 검증은 그쪽 테스트에서 다룬다.
