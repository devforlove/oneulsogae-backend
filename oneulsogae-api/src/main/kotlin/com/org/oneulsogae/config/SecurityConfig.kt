...
import com.org.oneulsogae.auth.JsonAuthenticationEntryPoint
import com.org.oneulsogae.auth.jwt.TokenAuthenticationFilter
import com.org.oneulsogae.auth.oauth.CustomOAuth2UserService
import com.org.oneulsogae.auth.oauth.LoginOriginCookieFilter
import com.org.oneulsogae.auth.oauth.OAuth2FailureHandler
		...
		http
			...
			.authorizeHttpRequests { request ->
				request
					...
					// 라운지 셀소 목록·상세·댓글 조회는 비로그인도 볼 수 있는 공개 콘텐츠다. (등록 POST·대화 신청·댓글 작성은 인증 유지)
					.requestMatchers(HttpMethod.GET, "/lounge/v1/self-intro-posts", "/lounge/v1/self-intro-posts/*", "/lounge/v1/self-intro-posts/*/comments").permitAll()
