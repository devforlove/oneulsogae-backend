		...
		http
			...
			.authorizeHttpRequests { request ->
				request
					...
					// 라운지 셀소 목록·상세 조회는 비로그인도 볼 수 있는 공개 콘텐츠다. (등록 POST·대화 신청은 인증 유지)
					.requestMatchers(HttpMethod.GET, "/lounge/v1/self-intro-posts", "/lounge/v1/self-intro-posts/*").permitAll()
