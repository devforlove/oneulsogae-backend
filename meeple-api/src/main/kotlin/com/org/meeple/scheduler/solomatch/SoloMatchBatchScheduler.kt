...
import com.org.meeple.scheduler.solomatch.command.adapter.SoloMatchBatchJob
import org.springframework.scheduling.annotation.Scheduled
import org.springframework.stereotype.Component

/**
 * 일일 매칭 배치 스케줄러(크론 트리거).
 * 정해진 크론 시각마다 meeple-scheduler 모듈의 [SoloMatchBatchJob]을 실행한다. 실행 주기는 meeple.match.batch.cron 프로퍼티로 조정한다.
