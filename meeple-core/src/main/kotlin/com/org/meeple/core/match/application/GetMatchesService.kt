package com.org.meeple.core.match.application

import com.org.meeple.common.user.Gender
import com.org.meeple.core.common.time.TimeGenerator
import com.org.meeple.core.match.application.port.`in`.GetMatchesUseCase
import com.org.meeple.core.match.application.port.`in`.RecommendMatchUseCase
...
class GetMatchesService(
	...
	private val getMatchWithPartnerPort: GetMatchWithPartnerPort,
	...
	override fun getMatches(userId: Long, isAfterOnboarding: Boolean): List<MatchWithPartner> {
		...
		return getMatchWithPartnerPort.findAllWithPartnerByUserId(userId, gender, now)
	}
}
