package com.org.meeple.core.chat.command.service.port.`in`

/**
 * 채팅방 나가기 인포트(유스케이스).
 * [userId]가 [chatRoomId] 채팅방에서 나간다. 해당 사용자의 참가자([com.org.meeple.core.chat.command.domain.ChatRoomMember]) 행을 소프트 삭제해
