 ...
 * 사용자+프로필 조인 조회 dao([UserWithDetailDao])에 위임하고, 없으면 [UserErrorCode.USER_DETAIL_NOT_FOUND]를 던진다.
 */
@Service
class GetUserWithDetailService(
	private val userWithDetailDao: UserWithDetailDao,
) : GetUserWithDetailUseCase {

	@Transactional(readOnly = true)
	override fun getByUserId(userId: Long): UserWithDetailView =
		userWithDetailDao.findWithDetailByUserId(userId)
