...
import com.org.meeple.core.user.query.dao.UserWithDetailQueryDao
 ...
 * 사용자+프로필 조인 조회 dao([UserWithDetailQueryDao])에 위임하고, 없으면 [UserErrorCode.USER_DETAIL_NOT_FOUND]를 던진다.
 */
@Service
class GetUserWithDetailService(
	private val userWithDetailQueryDao: UserWithDetailQueryDao,
) : GetUserWithDetailUseCase {

	@Transactional(readOnly = true)
	override fun getByUserId(userId: Long): UserWithDetailView =
		userWithDetailQueryDao.findWithDetailByUserId(userId)
