...
import com.org.meeple.core.alarm.command.application.port.out.MarkAlarmsReadPort
 ...
 * 보관 기간을 목록 조회([com.org.meeple.core.alarm.query.service.GetAlarmsService])와 일치시켜, 화면에 노출되는 알람만 읽음 처리한다.
 */
@Service
@Transactional
