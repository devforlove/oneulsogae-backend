...
dependencies {
	...
	// 실제 서블릿 컨테이너는 최종 애플리케이션(oneulsogae-api의 spring-boot-starter-webmvc)이 런타임에 제공하므로 compileOnly로 둔다.
	...
	testFixturesImplementation(project(":oneulsogae-common"))
	// IdentityVerificationEntityFixture가 core의 IdentityVerificationStatus를 참조한다.
	testFixturesImplementation(project(":oneulsogae-core"))
