...
/**
 * scheduler [GetTeamMatchRecordDao]의 QueryDSL 구현. (조회 전용 — 기록은 command [com.org.oneulsogae.infra.teammatch.command.adapter.TeamMatchAdapter]의 SaveTeamMatchRecordPort가 담당)
