...
import com.org.oneulsogae.infra.user.command.entity.CompanyEmailVerificationEntity
import org.springframework.data.jpa.repository.JpaRepository

/**
 * 회사 이메일 인증 엔티티에 대한 Spring Data JPA 리포지토리.
 * 도메인 포트는 [com.org.oneulsogae.infra.user.adapter.CompanyEmailVerificationRepositoryAdapter]가 구현한다.
 */
