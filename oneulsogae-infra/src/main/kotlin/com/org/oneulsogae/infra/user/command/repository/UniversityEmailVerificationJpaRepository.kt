...
import com.org.oneulsogae.infra.user.command.entity.UniversityEmailVerificationEntity
import org.springframework.data.jpa.repository.JpaRepository

/**
 * 학교 이메일 인증 엔티티에 대한 Spring Data JPA 리포지토리.
 * 도메인 포트는 [com.org.oneulsogae.infra.user.command.adapter.UniversityEmailVerificationRepositoryAdapter]가 구현한다.
 */
