package com.org.oneulsogae.infra.alarm.command.repository
 ...
 * 저장 out-port는 [com.org.oneulsogae.infra.alarm.command.adapter.AlarmAdapter]가 구현하고,
 * 조회는 [com.org.oneulsogae.infra.alarm.query.GetAlarmDaoImpl]가 QueryDSL로 담당한다.
 */
