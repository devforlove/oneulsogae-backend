package com.org.oneulsogae.infra.alarm.query
 ...
 * 저장 out-port([com.org.oneulsogae.core.alarm.command.application.port.out.SaveAlarmPort])는 [com.org.oneulsogae.infra.alarm.command.adapter.AlarmAdapter]가 따로 구현한다.
 */
@Component
