 ...
 * 저장·단건 로드는 [com.org.oneulsogae.infra.chat.command.adapter.ChatRoomAdapter](core SaveChatRoomPort/GetChatRoomPort)가 처리한다.
...
interface ChatRoomJpaRepository : JpaRepository<ChatRoomEntity, Long> {
	...
	@Query(
		...
		where r.id = :chatRoomId
		  and r.status = com.org.oneulsogae.common.chat.ChatRoomStatus.ACTIVE
