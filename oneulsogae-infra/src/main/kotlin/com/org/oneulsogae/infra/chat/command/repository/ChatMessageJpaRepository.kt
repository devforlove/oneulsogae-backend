 ...
 * 저장 out-port는 [com.org.oneulsogae.infra.chat.command.adapter.ChatMessageAdapter]가 구현한다.
 * 메세지 조회(키셋 페이지네이션)는 QueryDSL 구현체 [com.org.oneulsogae.infra.chat.query.GetChatMessageDaoImpl]가 담당한다.
 */
