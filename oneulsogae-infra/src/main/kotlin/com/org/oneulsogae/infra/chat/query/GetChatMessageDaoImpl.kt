...
import com.org.oneulsogae.core.chat.query.dto.ChatMessageView
 ...
 * 저장 out-port([com.org.oneulsogae.core.chat.command.application.port.out.SaveChatMessagePort])는 [ChatMessageAdapter]가 메서드 쿼리로 따로 구현한다.
 */
@Component
