...
import com.org.meeple.chatting.chat.adapter.web.AuthChannelInterceptor
 ...
 * - 발행(SEND) 목적지 prefix `/app`은 [com.org.meeple.chatting.chat.adapter.web.ChatMessageController]의 `@MessageMapping`으로 라우팅된다.
