...
import com.org.meeple.scheduler.match.application.port.out.SaveMatchPoolPort
import com.org.meeple.scheduler.match.application.port.out.TimeGenerator
...
import com.org.meeple.scheduler.match.domain.MatchPoolByGender
import com.org.meeple.scheduler.match.domain.MatchPoolGroup
...
class RunDailyMatchBatchService(
	private val getMatchBatchTargetPort: GetMatchBatchTargetPort,
	private val matchRecordPort: MatchRecordPort,
	private val getActiveUserPort: GetActiveUserPort,
	...
	override fun run(): MatchBatchResult {
		...
		while (true) {
			val page: List<MatchBatchTarget> = getMatchBatchTargetPort.findTargets(loginAfter, cursor, PAGE_SIZE)
