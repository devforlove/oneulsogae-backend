package com.org.meeple.scheduler.solomatch.command.application.port.out

import com.org.meeple.common.user.Gender
import java.time.LocalDateTime

/**
 * 배치가 매칭(소개) 이력을 기록하기 위한 아웃포트. (기록 전용 — 조회는 [com.org.meeple.scheduler.solomatch.query.dao.GetMatchRecordDao]가 담당)
