package com.org.meeple.scheduler.teammatch.command.application.port.out

import java.time.LocalDateTime

/**
 * 배치가 팀 매칭(소개) 이력을 기록하기 위한 아웃포트. (기록 전용 — 조회는 [com.org.meeple.scheduler.teammatch.query.dao.GetTeamMatchRecordDao]가 담당)
